...
public final class RawTestingCenter extends RecBase implements Comparable<RawTestingCenter> {
    ...
    /**
     * Constructs a new {@code RawTestingCenter} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawTestingCenter parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_TESTING_CENTER_ID.equals(name)) {
            this.testingCenterId = value;
        } else if (FLD_TC_NAME.equals(name)) {
            this.tcName = value;
        } else if (FLD_ADDRES_1.equals(name)) {
            this.addres1 = value;
        } else if (FLD_ADDRES_2.equals(name)) {
            this.addres2 = value;
        } else if (FLD_ADDRES_3.equals(name)) {
            this.addres3 = value;
        } else if (FLD_CITY.equals(name)) {
            this.city = value;
        } else if (FLD_STATE.equals(name)) {
            this.state = value;
        } else if (FLD_ZIP_CODE.equals(name)) {
            this.zipCode = value;
        } else if (FLD_ACTIVE.equals(name)) {
            this.active = value;
        ...
        } else if (FLD_DTIME_DENIED.equals(name)) {
            this.dtimeDenied = LocalDateTime.parse(value);
        } else if (FLD_DTIME_REVOKED.equals(name)) {
            this.dtimeRevoked = LocalDateTime.parse(value);
        } else if (FLD_IS_REMOTE.equals(name)) {
            this.isRemote = value;
        } else if (FLD_IS_PROCTORED.equals(name)) {
