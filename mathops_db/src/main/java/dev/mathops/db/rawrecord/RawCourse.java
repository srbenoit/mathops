...
public final class RawCourse extends RecBase implements Comparable<RawCourse> {
    ...
    /**
     * Constructs a new {@code RawCourse} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawCourse parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_COURSE.equals(name)) {
            this.course = value;
        } else if (FLD_NBR_UNITS.equals(name)) {
            this.nbrUnits = Integer.valueOf(value);
        } else if (FLD_COURSE_NAME.equals(name)) {
            this.courseName = value;
        } else if (FLD_NBR_CREDITS.equals(name)) {
            this.nbrCredits = Integer.valueOf(value);
        } else if (FLD_CALC_OK.equals(name)) {
            this.calcOk = value;
        } else if (FLD_COURSE_LABEL.equals(name)) {
            this.courseLabel = value;
        } else if (FLD_INLINE_PREFIX.equals(name)) {
            this.inlinePrefix = value;
        } else if (FLD_IS_TUTORIAL.equals(name)) {
            this.isTutorial = value;
        } else if (FLD_REQUIRE_ETEXT.equals(name)) {
            this.requireEtext = value;
        }
    }
     ...
     * @param theCalcOk       true if a calculator can lent to students enrolled in this course
    ...
    /**
     * Extracts an "course" record from a result set.
     *
    ...
    public int hashCode() {
        ...
        return EqualityTests.objectHashCode(this.course)
                + EqualityTests.objectHashCode(this.nbrUnits)
                + EqualityTests.objectHashCode(this.courseName)
                + EqualityTests.objectHashCode(this.nbrCredits)
                + EqualityTests.objectHashCode(this.calcOk)
                + EqualityTests.objectHashCode(this.courseLabel)
                + EqualityTests.objectHashCode(this.inlinePrefix)
                + EqualityTests.objectHashCode(this.isTutorial)
                + EqualityTests.objectHashCode(this.requireEtext);
    }
