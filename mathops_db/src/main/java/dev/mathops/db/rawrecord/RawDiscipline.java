...
public final class RawDiscipline extends RecBase implements Comparable<RawDiscipline> {
    ...
    /**
     * Constructs a new {@code RawDiscipline} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawDiscipline parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_STU_ID.equals(name)) {
            this.stuId = value;
        } else if (FLD_DT_INCIDENT.equals(name)) {
            this.dtIncident = LocalDate.parse(value);
        } else if (FLD_INCIDENT_TYPE.equals(name)) {
            this.incidentType = value;
        } else if (FLD_COURSE.equals(name)) {
            this.course = value;
        } else if (FLD_UNIT.equals(name)) {
            this.unit = Integer.valueOf(value);
        } else if (FLD_CHEAT_DESC.equals(name)) {
            this.cheatDesc = value;
        } else if (FLD_ACTION_TYPE.equals(name)) {
            this.actionType = value;
        } else if (FLD_ACTION_COMMENT.equals(name)) {
            this.actionComment = value;
        } else if (FLD_INTERVIEWER.equals(name)) {
            this.interviewer = value;
        } else if (FLD_PROCTOR.equals(name)) {
            this.proctor = value;
        }
    }
