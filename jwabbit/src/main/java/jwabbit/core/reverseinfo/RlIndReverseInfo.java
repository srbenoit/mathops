...
/**
 * The "rl_ind_reverse_info" opcode.
 */
public final class RlIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code RlIndReverseInfo}.
     */
    public RlIndReverseInfo() {

        // No action
    }

    /**
     * Opcode rl_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "rl_ind_reverse_info" function.
     */
    @Override
