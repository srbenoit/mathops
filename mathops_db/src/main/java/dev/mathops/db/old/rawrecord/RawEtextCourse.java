...
public final class RawEtextCourse extends RecBase implements Comparable<RawEtextCourse> {
    ...
    /**
     * Constructs a new {@code RawEtextCourse} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawEtextCourse parse(final String toParse) {
