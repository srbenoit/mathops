...
final class TestRawDupRegistr {
    ...
    void test0099() {
        ...
        final RawDupRegistr obj = RawDupRegistr.parse(EXPECT_SER99);
        ...
        assertEquals(TEST_FINAL_CLASS_ROLL, obj.finalClassRoll,
                "Invalid final_class_roll value after deserialization");
