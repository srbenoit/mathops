...
public final class RawCampusCalendar extends RecBase implements Comparable<RawCampusCalendar> {
    ...
    /**
     * Constructs a new {@code RawCampusCalendar} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawCampusCalendar parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_CAMPUS_DT.equals(name)) {
            this.campusDt = LocalDate.parse(value);
        } else if (FLD_DT_DESC.equals(name)) {
            this.dtDesc = value;
        } else if (FLD_OPEN_TIME1.equals(name)) {
            this.openTime1 = value;
        } else if (FLD_OPEN_TIME2.equals(name)) {
            this.openTime2 = value;
        } else if (FLD_CLOSE_TIME1.equals(name)) {
            this.closeTime1 = value;
        } else if (FLD_CLOSE_TIME2.equals(name)) {
            this.closeTime2 = value;
        } else if (FLD_WEEKDAYS_1.equals(name)) {
            this.weekdays1 = value;
        } else if (FLD_WEEKDAYS_2.equals(name)) {
            this.weekdays2 = value;
        }
    }
