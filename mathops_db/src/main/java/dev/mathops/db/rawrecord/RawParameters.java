...
public final class RawParameters extends RecBase implements Comparable<RawParameters> {
    ...
    /**
     * Constructs a new {@code RawParameters} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawParameters parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_PGM_NAME.equals(name)) {
            this.pgmName = value;
        } else if (FLD_PARM1.equals(name)) {
            this.parm1 = value;
        } else if (FLD_PARM2.equals(name)) {
            this.parm2 = value;
        } else if (FLD_PARM3.equals(name)) {
            this.parm3 = value;
        } else if (FLD_PARM4.equals(name)) {
            this.parm4 = value;
        } else if (FLD_PARM5.equals(name)) {
            this.parm5 = value;
        } else if (FLD_PARM6.equals(name)) {
            this.parm6 = value;
        } else if (FLD_PARM7.equals(name)) {
            this.parm7 = value;
        } else if (FLD_PARM8.equals(name)) {
            this.parm8 = value;
        } else if (FLD_PARM9.equals(name)) {
            this.parm9 = value;
        } else if (FLD_PARM10.equals(name)) {
            this.parm10 = LocalDate.parse(value);
        }
    }
