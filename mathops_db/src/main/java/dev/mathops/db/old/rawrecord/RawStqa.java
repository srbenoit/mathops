...
public final class RawStqa extends RecBase implements Comparable<RawStqa> {
    ...
    /**
     * Constructs a new {@code RawStqa} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStqa parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_SUBTEST.equals(name)) {
            this.subtest = value;
