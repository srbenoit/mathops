...
public final class RawLogins extends RecBase implements Comparable<RawLogins> {
    ...
    /**
     * Constructs a new {@code RawLogins} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawLogins parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_USER_ID.equals(name)) {
            this.userId = value;
        } else if (FLD_USER_TYPE.equals(name)) {
            this.userType = value;
        } else if (FLD_USER_NAME.equals(name)) {
            this.userName = value;
        } else if (FLD_STORED_KEY.equals(name)) {
            this.storedKey = value;
        } else if (FLD_SERVER_KEY.equals(name)) {
            this.serverKey = value;
        } else if (FLD_DTIME_CREATED.equals(name)) {
            this.dtimeCreated = LocalDateTime.parse(value);
        } else if (FLD_DTIME_EXPIRES.equals(name)) {
            this.dtimeExpires = LocalDateTime.parse(value);
        } else if (FLD_DTIME_LAST_LOGIN.equals(name)) {
            this.dtimeLastLogin = LocalDateTime.parse(value);
        } else if (FLD_FORCE_PW_CHANGE.equals(name)) {
            this.forcePwChange = value;
        } else if (FLD_EMAIL.equals(name)) {
            this.email = value;
        } else if (FLD_SALT.equals(name)) {
            this.salt = value;
        } else if (FLD_NBR_INVALID_ATMPTS.equals(name)) {
            this.nbrInvalidAtmpts = Integer.valueOf(value);
        }
    }
