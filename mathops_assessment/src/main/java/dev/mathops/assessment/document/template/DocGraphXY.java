...
//    }
    ...
    public void whyNotEqual(final Object other, final int indent) {
        ...
        if (other instanceof final DocGraphXY obj) {
            ...
            if (!Objects.equals(this.windowMaxX, obj.windowMaxX)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (windowMaxX: ", this.windowMaxX, "!=",
                        obj.windowMaxX, ")");
            }
            if (!Objects.equals(this.windowMinY, obj.windowMinX)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (windowMinY: ", this.windowMinY, "!=",
                        obj.windowMinY, ")");
            }
            if (!Objects.equals(this.windowMaxY, obj.windowMaxY)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (windowMaxY: ", this.windowMaxY, "!=",
                        obj.windowMaxY, ")");
            }
            if (!Objects.equals(this.xTickInterval, obj.xTickInterval)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (xTickInterval: " + this.xTickInterval + "!="
                        + obj.xTickInterval + ")");
            }
            if (!Objects.equals(this.yTickInterval, obj.yTickInterval)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (yTickInterval: " + this.yTickInterval + "!="
                        + obj.yTickInterval + ")");
            }

            if (!Objects.equals(this.backgroundColorName,
                    obj.backgroundColorName)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (backgroundColorName: ", this.backgroundColorName,
                        "!=", obj.backgroundColorName, ")");
            }

            if (this.borderWidth != obj.borderWidth) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (borderWidth: " + this.borderWidth + "!="
                        + obj.borderWidth + ")");
            }

            if (!Objects.equals(this.borderColorName, obj.borderColorName)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (borderColorName: ", this.borderColorName, "!=",
                        obj.borderColorName, ")");
            }

            if (this.gridWidth != obj.gridWidth) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (gridWidth: " + this.gridWidth + "!="
                        + obj.gridWidth + ")");
            }

            if (!Objects.equals(this.gridColorName, obj.gridColorName)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (gridColorName: ", this.gridColorName, "!=",
                        obj.gridColorName, ")");
            }

            if (this.tickWidth != obj.tickWidth) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (tickWidth: " + this.tickWidth + "!="
                        + obj.tickWidth + ")");
            }

            if (!Objects.equals(this.tickColorName, obj.tickColorName)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (tickColorName: ", this.tickColorName, "!=",
                        obj.tickColorName, ")");
            }

            if (this.tickSize != obj.tickSize) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (tickSize: " + this.tickSize + "!="
                        + obj.tickSize + ")");
            }

            if (this.axisWidth != obj.axisWidth) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (axisWidth: " + this.axisWidth + "!="
                        + obj.axisWidth + ")");
            }

            if (!Objects.equals(this.axisColorName, obj.axisColorName)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (axisColorName: ", this.axisColorName, "!=",
                        obj.axisColorName, ")");
            }

            if (this.axisLabelSize != obj.axisLabelSize) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (axisLabelSize: " + this.axisLabelSize + "!="
                        + obj.axisLabelSize + ")");
            }

            if (this.tickLabelSize != obj.tickLabelSize) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (tickLabelSize: " + this.tickLabelSize + "!="
                        + obj.tickLabelSize + ")");
            }

            if (!Objects.equals(this.xAxisLabel, obj.xAxisLabel)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (xAxisLabel: ", this.xAxisLabel, "!=",
                        obj.xAxisLabel, ")");
            }

            if (!Objects.equals(this.yAxisLabel, obj.yAxisLabel)) {
                Log.info(makeIndent(indent), "UNEQUAL DocGraphXY (yAxisLabel: ", this.yAxisLabel, "!=",
                        obj.yAxisLabel, ")");
            }
            ...
            if (!Objects.equals(getPrimitives(), obj.getPrimitives())) {
                if (getPrimitives() == null || obj.getPrimitives() == null) {
                    ...
                    final int numPrim = getPrimitives().size();
                    if (numPrim != obj.getPrimitives().size()) {
                        Log.info(makeIndent(indent), "UNEQUAL DocDrawing (primitives size: " + getPrimitives().size() + "!="
                                + obj.getPrimitives().size() + ")");
                    } else {
            ...
            Log.info(makeIndent(indent), "UNEQUAL DocGraphXY because other is ", other.getClass().getName());
        }
    }
}
