...
//                        }
                        ...
                        if (appTerm != null && appTerm.length() == 6) {
                            ...
                            try {
                                if (appTerm.endsWith("90")) {
                                    applicationTerm = new TermKey(ETermName.FALL, Integer.parseInt(year));
                                } else if (appTerm.endsWith("10")) {
                                    applicationTerm = new TermKey(ETermName.SPRING, Integer.parseInt(year));
                                } else if (appTerm.endsWith("60")) {
                                    applicationTerm = new TermKey(ETermName.SUMMER, Integer.parseInt(year));
                                }
                        ...
                        final ApplicantRecord newRec = new ApplicantRecord(csuId, firstName, lastName, prefName,
                                ...
                                residencyState, hsGpa, hsClassRank, hsClassSize, actMath, usedSat, pidm,
