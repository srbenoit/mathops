...
public final class S104UploadQueuedPlacementScores extends StepExecutable {
    ...
    private static final String[] MESSAGE = {
            ...
            "then run an audit of placement test scores in Banner."};

    /**
     * Constructs a new {@code S104UploadQueuedPlacementScores}.  This should be called on the AWT event dispatch thread.
     *
