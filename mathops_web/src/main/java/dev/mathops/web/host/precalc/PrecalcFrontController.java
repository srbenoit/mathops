...
/**
 * The front controller for the "precalc.[domain]" host.
 *
 * <p>
 ...
 */
public final class PrecalcFrontController extends HttpServlet {
    ...
    private IMidController precalcMidController = null;
    ...
    /**
     * Constructs a new {@code PrecalcFrontController}.
     */
    public PrecalcFrontController() {
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        this.precalcMidController = new PrecalcMidController(config);
    ...
    private void serviceSecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.precalcMidController.serviceSecure(req, resp, requestPath);
        }
    }
    ...
    private void serviceInsecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.precalcMidController.serviceInsecure(req, resp, requestPath);
        }
    }
