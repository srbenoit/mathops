...
/**
 * A page with the "homework_submission" placement.
 */
enum PageHomeworkSubmission {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Homework Submission");
        }
    }
}
