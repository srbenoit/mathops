package dev.mathops.web.host.course;
 ...
 */
public final class CourseFrontController extends HttpServlet {
    ...
    private IMidController courseMidController = null;
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        this.courseMidController = new CourseMidController(config);
    ...
    private void serviceSecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.courseMidController.serviceSecure(req, resp, requestPath);
        }
    }
    ...
    private void serviceInsecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.courseMidController.serviceInsecure(req, resp, requestPath);
        }
    }
