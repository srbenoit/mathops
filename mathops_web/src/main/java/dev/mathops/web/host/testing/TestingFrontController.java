 ...
 */
public final class TestingFrontController extends HttpServlet {
    ...
    private IMidController testingMidController = null;
    ...
    /**
     * Constructs a new {@code NoCronFrontController}.
     */
    public TestingFrontController() {
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        this.testingMidController = new TestingMidController(config);
    ...
    private void serviceSecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.testingMidController.serviceSecure(req, resp, requestPath);
        }
    }
    ...
    private void serviceInsecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.testingMidController.serviceInsecure(req, resp, requestPath);
        }
    }
