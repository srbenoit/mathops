...
/**
 * The "rr_ind_reverse_info" opcode.
 */
public final class RrIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code RrIndReverseInfo}.
     */
    public RrIndReverseInfo() {

        // No action
    }

    /**
     * Opcode rr_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "rr_ind_reverse_info" function.
     */
    @Override
