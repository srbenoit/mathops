...
/**
 * Constructs the "exam_tester.jar" app JAR file.
 *
 * <p>
 ...
 * </pre>
 */
final class ExamTesterJarBuilder {
    ...
    /**
     * Constructs a new {@code ExamTesterJarBuilder}.
     */
    private ExamTesterJarBuilder() {
    ...
    private void build() {
        ...
        if (success) {
            try (final FileOutputStream out = new FileOutputStream(new File(jars, "exam_tester.jar"));
                ...
                jar.finish();
                Log.finest(Res.fmt(Res.JAR_DONE, "exam_tester"), CoreConstants.CRLF);
    ...
    private static void addManifest(final JarOutputStream jar) throws IOException {
        ...
        htm.addln("Created-By: ExamTesterJarBuilder 1.01");
        htm.addln("Main-Class: edu.colostate.math.system.assessment.app.localtesting.LocalTestingApp");
        htm.addln("Class-Path: jwabbit.jar flatlaf-3.0.jar");
    ...
    public static void main(final String... args) {
        ...
        new ExamTesterJarBuilder().build();
