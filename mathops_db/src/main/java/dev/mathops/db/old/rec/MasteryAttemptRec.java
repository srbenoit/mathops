...
public final class MasteryAttemptRec extends RecBase implements Comparable<MasteryAttemptRec> {
    ...
    /**
     * Constructs a new {@code MasteryAttemptRec} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static MasteryAttemptRec parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_WHEN_FINISHED.equals(name)) {
            this.whenFinished = LocalDateTime.parse(value);
