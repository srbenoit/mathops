...
public final class RawRemoteMpe extends RawTermRecordBase implements Comparable<RawRemoteMpe> {
    ...
    /**
     * Constructs a new {@code RawRemoteMpe} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawRemoteMpe parse(final String toParse) {
