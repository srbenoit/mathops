...
import dev.mathops.db.schema.legacy.impl.RawStchallengeqaLogic;
...
//    }
    ...
    private void startMain(final HtmlBuilder htm) {
        ...
        htm.addln("<div style='padding:8px;min-height:100%;border:1px solid #b3b3b3;background:#f8f8f8;",
