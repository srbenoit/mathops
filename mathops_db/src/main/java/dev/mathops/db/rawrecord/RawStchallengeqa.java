...
public final class RawStchallengeqa extends RecBase implements Comparable<RawStchallengeqa> {
    ...
    /**
     * Constructs a new {@code RawStchallengeqa} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStchallengeqa parse(final String toParse) {
    ...
    /**
     * Extracts an "stchallengeqa" record from a result set.
     *
