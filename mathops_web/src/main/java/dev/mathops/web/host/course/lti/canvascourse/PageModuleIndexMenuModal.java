...
/**
 * A page with the "module_index_menu_modal" placement.
 */
enum PageModuleIndexMenuModal {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Module Index Menu (Modal)");
        }
    }
}
