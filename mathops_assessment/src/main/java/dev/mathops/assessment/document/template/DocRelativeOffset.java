...
public final class DocRelativeOffset extends AbstractDocContainer {
    ...
    public void whyNotEqual(final Object other, final int indent) {
        ...
        if (other instanceof final DocRelativeOffset obj) {
            innerWhyNotEqual(obj, indent);

            if (!Objects.equals(this.base, obj.base)) {
                if (this.base == null || obj.base == null) {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (base: ", this.base, CoreConstants.SLASH,
                            obj.base, ")");
                } else {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (base...)");
                    this.base.whyNotEqual(obj.base, indent + 1);
                }
            }

            if (!Objects.equals(this.superscript, obj.superscript)) {
                if (this.superscript == null || obj.superscript == null) {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (superscript: ", this.superscript,
                            CoreConstants.SLASH, obj.superscript, ")");
                } else {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (superscript...)");
                    this.superscript.whyNotEqual(obj.superscript, indent + 1);
                }
            }

            if (!Objects.equals(this.subscript, obj.subscript)) {
                if (this.subscript == null || obj.subscript == null) {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (subscript: ", this.subscript,
                            CoreConstants.SLASH, obj.subscript, ")");
                } else {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (subscript...)");
                    this.subscript.whyNotEqual(obj.subscript, indent + 1);
                }
            }

            if (!Objects.equals(this.over, obj.over)) {
                if (this.over == null || obj.over == null) {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (over: ", this.over, CoreConstants.SLASH,
                            obj.over, ")");
                } else {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (over...)");
                    this.over.whyNotEqual(obj.over, indent + 1);
                }
            }

            if (!Objects.equals(this.under, obj.under)) {
                if (this.under == null || obj.under == null) {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (under: ", this.under, CoreConstants.SLASH,
                            obj.under, ")");
                } else {
                    Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset (under...)");
                    this.under.whyNotEqual(obj.under, indent + 1);
                }
            }
        } else {
            Log.info(makeIndent(indent), "UNEQUAL DocRelativeOffset because other is ", other.getClass().getName());
        }
    }
}
