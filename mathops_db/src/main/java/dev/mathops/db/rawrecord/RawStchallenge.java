...
public final class RawStchallenge extends RecBase implements Comparable<RawStchallenge> {
    ...
    /**
     * Constructs a new {@code RawStchallenge} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStchallenge parse(final String toParse) {
    ...
    /**
     * Extracts an "stchallenge" record from a result set.
     *
