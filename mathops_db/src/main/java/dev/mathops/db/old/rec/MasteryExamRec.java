...
public final class MasteryExamRec extends RecBase implements Comparable<MasteryExamRec> {
    ...
    /**
     * Constructs a new {@code MasteryExamRec} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static MasteryExamRec parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_EXAM_ID.equals(name)) {
            ...
            this.title = value;
        } else if (FLD_BUTTON_LABEL.equals(name)) {
