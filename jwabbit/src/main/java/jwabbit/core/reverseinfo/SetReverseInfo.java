...
/**
 * The "set_reverse_info" opcode.
 */
public final class SetReverseInfo implements IRevOpcode {

    /**
     * Constructs a new {@code SetReverseInfo}.
     */
    public SetReverseInfo() {

        // No action
    }

    /**
     * Opcode set_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "set_reverse_info" function.
     */
    @Override
