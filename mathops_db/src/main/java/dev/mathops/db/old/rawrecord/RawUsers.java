...
public final class RawUsers extends RawTermRecordBase implements Comparable<RawUsers> {
    ...
    /**
     * Constructs a new {@code RawUsers} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawUsers parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_CALC_COURSE.equals(name)) {
            this.calcCourse = value;
