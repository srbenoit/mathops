...
/**
 * The "res_ind_reverse_info" opcode.
 */
public final class ResIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code ResIndReverseInfo}.
     */
    public ResIndReverseInfo() {

        // No action
    }

    /**
     * Opcode res_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "res_ind_reverse_info" function.
     */
    @Override
