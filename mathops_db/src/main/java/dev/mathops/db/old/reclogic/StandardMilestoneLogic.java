...
public abstract class StandardMilestoneLogic implements IRecLogic<StandardMilestoneRec> {
     ...
     * @throws SQLException if there is an error performing the query
     */
    public abstract StandardMilestoneRec query(Cache cache, String track, Integer pace,
                                               Integer paceIndex, Integer unit, Integer objective, String msType) throws SQLException;
     ...
     * @throws SQLException if there is an error performing the query
     */
    public abstract List<StandardMilestoneRec> generalQuery(Cache cache, Criteria queryCriteria)
            throws SQLException;
    ...
    public static final class Informix extends StandardMilestoneLogic
            implements IInformixRecLogic<StandardMilestoneRec> {
        ...
        public List<StandardMilestoneRec> queryAll(final Cache cache) throws SQLException {
            ...
            return doListQuery(cache, "SELECT * FROM std_milestone");
        }
         ...
         */
        @Override
        public List<StandardMilestoneRec> generalQuery(final Cache cache, final Criteria queryCriteria)
                throws SQLException {

            final HtmlBuilder sql = new HtmlBuilder(150);

            sql.add("SELECT * FROM std_milestone");

            String w = stringWhere(sql, WHERE, "pace_track", queryCriteria.paceTrack);
    ...
    public static final class Postgres extends StandardMilestoneLogic
            implements IPostgresRecLogic<StandardMilestoneRec> {
