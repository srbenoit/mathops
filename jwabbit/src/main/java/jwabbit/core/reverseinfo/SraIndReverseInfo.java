...
/**
 * The "sra_ind_reverse_info" opcode.
 */
public final class SraIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code SraIndReverseInfo}.
     */
    public SraIndReverseInfo() {

        // No action
    }

    /**
     * Opcode sra_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "sra_ind_reverse_info" function.
     */
    @Override
