...
public final class VariableRandomInteger extends AbstractFormattableVariable
    ...
    public void whyNotEqual(final AbstractVariable obj, final int indent) {
        ...
        if (obj instanceof final VariableRandomInteger var) {
            ...
            if (!Objects.equals(this.exclude, var.exclude)) {
                if (this.exclude == null || var.exclude == null) {
                    Log.info(makeIndent(indent), "UNEQUAL VariableRandomInt (exclude: " + this.exclude + "!="
                            + var.exclude + ")");
                } else {
                    ...
                    if (excludeLen == var.exclude.length) {
                        for (int i = 0; i < excludeLen; ++i) {
                            ...
                            if (!Objects.equals(f1, f2)) {
                                if (f1 == null || f2 == null) {
                                    Log.info(makeIndent(indent), "UNEQUAL VariableRandomInt (exclude[",
                        ...
                        Log.info(makeIndent(indent), "UNEQUAL VariableRandomInt (exclude.length: "
                                + Integer.valueOf(this.exclude.length) + "!=" + Integer.valueOf(var.exclude.length) + ")");
                    }
                }
            }
        }
