...
REM ---------------------------------------------------------------------------
ECHO.
ECHO == Building Precalc Program Library
REM ---------------------------------------------------------------------------

IF EXIST %TARGET%\precalc.jar    DEL %TARGET%\precalc.jar
CD %BIN%
XCOPY /Q /E *.*  %TEMP%\.
...
REM ---------------------------------------------------------------------------
ECHO Creating "precalc.jar" file
REM ---------------------------------------------------------------------------


%JAR% %TARGET%\precalc.jar manifest-additions.txt edu jwabbit
