 ...
 */
public final class PlacementTransferPanel extends AdmPanelBase implements ActionListener {
     ...
     */
    public PlacementTransferPanel(final Cache theCache, final UserData theFixed) {
