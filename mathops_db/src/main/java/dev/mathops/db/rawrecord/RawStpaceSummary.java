...
public final class RawStpaceSummary extends RawTermRecordBase implements Comparable<RawStpaceSummary> {
    ...
    /**
     * Constructs a new {@code RawStpaceSummary} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStpaceSummary parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_MS_UNIT.equals(name)) {
            this.msUnit = Integer.valueOf(value);
        } else if (FLD_MS_DATE.equals(name)) {
            this.msDate = LocalDate.parse(value);
        } else if (FLD_NEW_MS_DATE.equals(name)) {
            this.newMsDate = value;
        } else if (FLD_EXAM_DT.equals(name)) {
            this.examDt = LocalDate.parse(value);
        } else if (FLD_RE_POINTS.equals(name)) {
            this.rePoints = Integer.valueOf(value);
        }
    }
    ...
    /**
     * Extracts an "stpace_summary" record from a result set.
     *
