...
/**
 * An integer-valued input variable.
 */
public final class VariableInputInteger extends AbstractVariable {

    /** XML type tag. */
    static final String TYPE_TAG = "input-int";

    /**
     * Constructs a new {@code VariableInputInteger}.
     *
     * @param theName the variable name
     */
    public VariableInputInteger(final String theName) {
    ...
    public EVariableType getVariableType() {
        ...
        return EVariableType.INPUT_INTEGER;
    }
     ...
     */
    @Override
    VariableInputInteger deepCopy() {

        final VariableInputInteger copy = new VariableInputInteger(this.name);
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == this) {
            equal = true;
        } else if (obj instanceof final VariableInputInteger variable) {
