...
/**
 * A page with the "assignment_index_menu" placement.
 */
enum PageAssignmentIndexMenu {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Assignment Index Menu");
        }
    }
}
