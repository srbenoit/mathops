...
/**
 * Represents a website (define db by host), with a map from path to data profile.
 *
 * <p>
 * XML Representation:
 *
...
public final class WebSiteContext {
     ...
     */
    WebSiteContext(final String theHost, final Map<String, DataProfile> thePaths) {
    ...
    public String toString() {
        ...
        return SimpleBuilder.concat("WebSiteContext{host='", this.host, "', paths={", this.paths, "}}");
    }
}
