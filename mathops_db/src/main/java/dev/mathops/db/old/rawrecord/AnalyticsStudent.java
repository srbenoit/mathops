...
public final class AnalyticsStudent extends RecBase implements Comparable<AnalyticsStudent> {
    ...
    public int hashCode() {
        ...
        return EqualityTests.objectHashCode(this.pidm)
                ...
                + EqualityTests.objectHashCode(this.gpa)
                + EqualityTests.objectHashCode(this.sex)
                + EqualityTests.objectHashCode(this.hispLatRace)
                + EqualityTests.objectHashCode(this.amerIndRace)
                + EqualityTests.objectHashCode(this.asianRace)
                + EqualityTests.objectHashCode(this.blackRace)
                + EqualityTests.objectHashCode(this.hawaiianRace)
                + EqualityTests.objectHashCode(this.whiteRace)
                + EqualityTests.objectHashCode(this.multiRace)
                + EqualityTests.objectHashCode(this.aplnTerm)
                + EqualityTests.objectHashCode(this.admitTerm)
                + EqualityTests.objectHashCode(this.admitProgram)
                + EqualityTests.objectHashCode(this.hsCode)
                + EqualityTests.objectHashCode(this.hsGradDate)
                + EqualityTests.objectHashCode(this.hsGpa)
                + EqualityTests.objectHashCode(this.hsClassRank)
                + EqualityTests.objectHashCode(this.hsClassSize)
                + EqualityTests.objectHashCode(this.actMath)
                + EqualityTests.objectHashCode(this.satMath)
                + EqualityTests.objectHashCode(this.satrMath);
    }
