...
public final class RawFinalCroll extends RawTermRecordBase implements Comparable<RawFinalCroll> {
    ...
    /**
     * Constructs a new {@code RawFinalCroll} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawFinalCroll parse(final String toParse) {
