...
/**
 * A real-valued input variable.
 */
public final class VariableInputReal extends AbstractFormattableVariable {

    /** XML type tag. */
    static final String TYPE_TAG = "input-real";

    /**
     * Constructs a new {@code VariableInputReal}.
     *
     * @param theName the variable name
     */
    public VariableInputReal(final String theName) {
    ...
    public EVariableType getVariableType() {
        ...
        return EVariableType.INPUT_REAL;
    }
     ...
     */
    @Override
    VariableInputReal deepCopy() {

        final VariableInputReal copy = new VariableInputReal(this.name);
