...
/**
 * A page with the "discussion_topic_index_menu" placement.
 */
enum PageDiscussionTopicIndexMenu {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Topic Index Menu");
        }
    }
}
