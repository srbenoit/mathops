...
import dev.mathops.db.rawlogic.RawSthwqaLogic;
...
import dev.mathops.db.rawrecord.RawSthwqa;
...
//    }
    ...
    private void appendHeader(final HtmlBuilder htm) {
        ...
        htm.addln("<div style='padding:6pt; border:1px solid #b3b3b3; background:#d8e9ff;font-family:serif; font-size:",
