...
public enum PageTopicSkillsReview {
                ...
                if (metaCourse == null) {
                    ...
                    for (final MetadataCourseModule metaCourseModule : metaCourse.modules) {
                        if (topicId.equals(metaCourseModule.id)) {
                            presentSkillsReviewPage(cache, site, req, resp, registration, csection, metaCourse,
                                    metaCourseModule);
                            seeking = false;
                            break;
                        }
    ...
    static void presentSkillsReviewPage(final Cache cache, final CanvasSite site, final ServletRequest req,
        ...
        if (meta.isValid()) {
            emitTopicSkillsReview(cache, site, req, resp, registration, csection, metaCourse, metaCourseModule,
