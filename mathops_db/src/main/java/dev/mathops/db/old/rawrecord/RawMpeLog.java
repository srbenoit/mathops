...
public final class RawMpeLog extends RecBase implements Comparable<RawMpeLog> {
    ...
    /**
     * Constructs a new {@code RawMpeLog} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawMpeLog parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_RECOVER_DT.equals(name)) {
            this.recoverDt = LocalDate.parse(value);
