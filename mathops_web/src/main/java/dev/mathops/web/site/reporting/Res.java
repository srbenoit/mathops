...
final class Res extends ResBundle {
    ...
    private static final String[][] EN_US = {
            ...
            {SITE_TITLE, "Precalculus Center Reporting"},
            {LANDING_HEADING, "Welcome to the Precalculus Center Report Hub"},
            {HOME_HEADING, "Precalculus Center Report Hub"},
    };
