...
public final class RawHighSchools extends RecBase implements Comparable<RawHighSchools> {
    ...
    /**
     * Constructs a new {@code RawHighSchools} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawHighSchools parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_HS_CODE.equals(name)) {
            this.hsCode = value;
        } else if (FLD_HS_NAME.equals(name)) {
            this.hsName = value;
