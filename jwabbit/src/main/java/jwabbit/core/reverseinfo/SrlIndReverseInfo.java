...
/**
 * The "srl_ind_reverse_info" opcode.
 */
public final class SrlIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code SrlIndReverseInfo}.
     */
    public SrlIndReverseInfo() {

        // No action
    }

    /**
     * Opcode srl_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "srl_ind_reverse_info" function.
     */
    @Override
