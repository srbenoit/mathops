 ...
 * The "rra" opcode.
 */
public final class Rra implements IOpcode {

    /**
     * Constructs a new {@code Rra}.
     */
    public Rra() {
     ...
     *
     * <p>
     * WABBITEMU SOURCE: core/alu.c, "rra" function.
     */
    @Override
    public int exec(final CPU cpu) {

        final int result = ((cpu.getA() >> 1) + ((cpu.getF() & 1) << 7)) & 0xFF;
