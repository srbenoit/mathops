...
public final class RawSthomework extends RecBase implements Comparable<RawSthomework> {
    ...
    /**
     * Constructs a new {@code RawSthomework} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawSthomework parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_HW_SCORE.equals(name)) {
            this.hwScore = Integer.valueOf(value);
        ...
        } else if (FLD_TIME_OK.equals(name)) {
            this.timeOk = value;
        } else if (FLD_PASSED.equals(name)) {
            this.passed = value;
        } else if (FLD_HW_TYPE.equals(name)) {
            this.hwType = value;
        ...
        } else if (FLD_HW_COUPON.equals(name)) {
            this.hwCoupon = value;
        } else if (FLD_USED_DT.equals(name)) {
            this.usedDt = LocalDate.parse(value);
        } else if (FLD_USED_SERIAL_NBR.equals(name)) {
            this.usedSerialNbr = Long.valueOf(value);
        }
    }
    ...
    /**
     * Extracts an "sthomework" record from a result set.
     *
