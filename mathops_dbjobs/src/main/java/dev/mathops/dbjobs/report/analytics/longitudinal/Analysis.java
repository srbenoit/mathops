...
public final class Analysis {
    ...
    public void execute(final File enrollmentsFile, final File studentTermsFile, final File majorsFile) {
        ...
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH117", allSects, "STAT311", allSects); // N=755
        ...
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH118", allSects, "CHEM111", allSects); //
        // N=10568
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH118", allSects, "CS156", allSects); // N=331
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH118", allSects, "CS160", allSects); // N=746
        ...
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH118", allSects, "STAT311", allSects); // N=804
        ...
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH124", allSects, "STAT311", allSects); // N=769
        ...
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH125", allSects, "STAT311", allSects); // N=296
        ...
        seqSuccess.generate(START_TERM, END_TERM, enrollments, "MATH126", allSects, "STAT311", allSects); // N=226
