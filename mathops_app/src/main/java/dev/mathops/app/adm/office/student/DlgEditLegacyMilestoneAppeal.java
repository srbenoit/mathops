...
public final class DlgEditLegacyMilestoneAppeal extends JFrame implements ActionListener, DocumentListener {
    ...
    private RawMilestone currentMilestone;
     ...
     */
    public DlgEditLegacyMilestoneAppeal(final Cache theCache, final IPaceAppealsListener theListener) {
        ...
        appealPanel.add(this.statusLabel, StackedBorderLayout.NORTH);
        ...
        if (Objects.nonNull(this.currentMilestone)) {
            final String paceStr = this.currentMilestone.pace.toString();
            this.paceField.setText(paceStr);
            this.paceField.setEditable(false);

            this.paceTrackField.setText(this.currentMilestone.paceTrack);
            this.paceTrackField.setEditable(false);

            final int courseIndex = this.currentMilestone.getIndex();
     ...
     * @param theMilestone the milestone for which an appeal is being edited
    ...
    public void populateDisplay(final UserData userData, final StudentData data, final RawMilestone theMilestone,
        ...
        this.currentMilestone = theMilestone;
