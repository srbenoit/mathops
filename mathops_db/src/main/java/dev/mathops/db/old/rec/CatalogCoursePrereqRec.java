...
public final class CatalogCoursePrereqRec extends RecBase {
    ...
    /**
     * Constructs a new {@code CatalogCoursePrerequisiteRec} by parsing the string format generated by
     ...
     */
    public static CatalogCoursePrereqRec parse(final String toParse) {

        final CatalogCoursePrereqRec result = new CatalogCoursePrereqRec();
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_PREREQ_ID.equals(name)) {
            this.prereqId = value;
        } else if (FLD_PARENT_PREREQ_ID.equals(name)) {
            this.parentPrereqId = value;
        } else if (FLD_PREREQ_TYPE.equals(name)) {
            this.prereqType = ECatalogCoursePrereqType.forCode(value);
        } else if (FLD_COURSE_ID.equals(name)) {
            this.courseId = CatalogCourseNumber.parse(value);
        } else if (FLD_MIN_GRADE.equals(name)) {
            this.minGrade = value;
        } else if (FLD_CONCURRENT.equals(name)) {
