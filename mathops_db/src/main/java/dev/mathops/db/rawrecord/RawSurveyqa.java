...
public final class RawSurveyqa extends RawTermRecordBase implements Comparable<RawSurveyqa> {
    ...
    /**
     * Constructs a new {@code RawSurveyqa} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawSurveyqa parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_TERM.equals(name)) {
            ...
            this.version = value;
        } else if (FLD_SURVEY_NBR.equals(name)) {
            this.surveyNbr = Integer.valueOf(value);
        } else if (FLD_QUESTION_DESC.equals(name)) {
            this.questionDesc = value;
        } else if (FLD_TYPE_QUESTION.equals(name)) {
            this.typeQuestion = value;
        } else if (FLD_ANSWER.equals(name)) {
            this.answer = value;
        } else if (FLD_ANSWER_DESC.equals(name)) {
            this.answerDesc = value;
        } else if (FLD_ANSWER_MEANING.equals(name)) {
            this.answerMeaning = value;
        } else if (FLD_MUST_ANSWER.equals(name)) {
            this.mustAnswer = value;
