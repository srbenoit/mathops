...
/**
 * A factory class that can generate a "Welcome" message.
 */
public enum WelcomeMessageFactory   {
    ;
    ...
    private static MessageToSend generateWELCst00(final MessagingContext context,
        ...
        emitStartParagraph(body, context);
        emitStartHelp(body);
     ...
     * @param context the messaging context
     */
    private static void emitStartParagraph(final HtmlBuilder body, final MessagingContext context) {

        body.add("You should find your courses in Canvas (https://colostate.instructure.com), ",
                "each with some information and a link to the main course web site.  Once you get to ",
                "the course page, read over the Student Guide to see how the program works.  Once you ",
                "get started, remember to check the \"Exam Deadlines\" link to stay on track with due ",
                "dates");

        if (context.pace == 5) {
            body.addln(" - five courses in one semester puts you on a pretty fast pace!");
        } else if (context.pace == 4) {
            body.addln(" - four courses in one semester puts you on a pretty fast pace!");
        } else if (context.pace == 3) {
            body.addln(" - three courses in one semester means deadlines will come along ",
                    "regularly.");
        } else {
            body.addln(".");
        }
    ...
    private static MessageToSend generateWELCus00(final MessagingContext context,
        ...
        body.add("It looks like you've found your courses in Canvas, and gotten in to the course ",
     ...
     * @return the report row
     */
    private static MessageToSend generateWELCSR0(final MessagingContext context,
                                                 final MessagingCourseStatus status) {
     ...
     * @return the report row
     */
    private static MessageToSend generateWELCSR1(final MessagingContext context,
                                                 final MessagingCourseStatus status) {
        ...
        body.add(" It looks like you've already passed the User's Exam - excellent!  Your next ",
                ...
                "on the first try, you can dive right in to the main course content.  If not, some ",
                "review materials will open up and you can review and take the Skills Review exam ",
                "again.  Remember to check the \"Exam Deadlines\" links to stay on track with due ",
                "dates");
     ...
     * @return the report row
     */
    private static MessageToSend generateWELCSR2(final MessagingContext context,
                                                 final MessagingCourseStatus status) {
        ...
        body.add(" It looks like you've already passed the User's Exam - excellent!  Your next ",
                ...
                "the \"Exam Deadlines\" links to stay on track with due dates");
     ...
     * @return the report row
     */
    private static MessageToSend generateWELCSR3(final MessagingContext context,
                                                 final MessagingCourseStatus status) {
        ...
        if (context.pace == 5) {
            ...
            body.addln(" - three courses in one semester means deadlines will come along regularly.");
        } else {
            body.addln(".");
        }
        body.addln();
     ...
     * @return the report row
     */
    private static MessageToSend generateWELCSR4(final MessagingContext context,
                                                 final MessagingCourseStatus status) {
    ...
    /**
     * Generates a report row for a "**WELCSR5" message. This applies to students who have attempted the Skills Review
     ...
     * @return the report row
     */
    private static MessageToSend generateWELCSR5(final MessagingContext context,
                                                 final MessagingCourseStatus status) {
    ...
    private static MessageToSend generateWELOK0(final MessagingContext context,
        ...
        if (status.passedFIN) {
            ...
            body.add("I see you've already powered through all four units - that's amazing!  ",
                    "All you have left to do is to pass the Final exam.  Then you can re-test on any of ",
                    "the Unit or Final exams to try to increase your point total.");
        } else {
            if (status.passedUE3) {
                body.add("I see you've already powered through three units - that's amazing!  ",
                        "If you finish up Unit 4 and pass the Final exam, you should be done with the ",
                        "course.  After that, you can re-test on any of the Unit or Final exams to try ",
                        "to increase your point total.");
            } else if (status.passedUE2) {
                body.add(
                        "I see you've already powered through two units - excellent!  It looks like ",
                        "you have things under control.  Once you've passed the last units and the Final ",
                        "Exam, you can re-test on any of the Unit or Final exams to try to increase your ",
                        "point total.");
            } else if (status.passedUE1) {
                body.add("I see you've already powered through Unit 1 - excellent!  It looks like ",
                        "you have things under control.  Once you've passed the other three units and the ",
                        "Final Exam, you can re-test on any of the Unit or Final exams to try to increase ",
                        "your point total.");
            ...
            if (context.pace == 5) {
                body.addln("Also, remember to check the \"Exam Deadlines\" link on the course ",
                        "page to stay on track with the fast pace of taking five Precalculus courses ",
                        "in one term.");
            } else if (context.pace == 4) {
                body.addln("Also, remember to check the \"Exam Deadlines\" link on the course ",
                        "page to stay on track with the fast pace of taking four Precalculus courses ",
                        "in one term.");
            } else {
                body.addln("Also, remember to check the \"Exam Deadlines\" link on the course ",
                        "page to stay on track.");
            }
        }
        body.addln();
    ...
    private static void emitOpening(final RawStudent stu, final MessagingContext context,
        ...
        body.addln("Welcome to the Precalculus Program!  My name is Anita Pattison - one of the ",
                ...
                "doing.  I want to do all I can to help you to succeed in your Precalculus courses.  ",
                "If you're on track, I'll try not to bother you too much, except maybe with reminders ",
                "of important due dates. But if it seems like you might be struggling with something, ",
                "I will reach out to see how I can help.");
        body.addln();

        body.add("These courses consist of online lessons and online assignments, followed by ");
        ...
        body.addln("An important note: these are not self-paced courses!  Unit Review exams and ",
        ...
        body.addln("These courses participate in the CSU Bookstore's \"Day One Access\" program, ",
                "which means the e-text will automatically be activated and charged to your student ",
                "account (I believe the cost is $19).  This e-text covers all the 1-credit ",
                "Precalculus courses you are enrolled in this semester.");
        body.addln();
    }
