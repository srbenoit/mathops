...
/**
 * The port 16 (0x10) device for the TI 83pse hardware.
 */
public final class D83psePort10 extends AbstractDevice {

    /** The LCD to which this device interfaces. */
    private AbstractLCDBase lcd;

    /**
     * Constructs a new {@code Device83psePort10}.
     *
     * @param theDevIndex the index at which this device is installed
     */
    public D83psePort10(final int theDevIndex) {
    ...
    /**
     * WABBITEMU SOURCE: hardware/83psehw.c, "port10_83pse" function.
     *
     * @param cpu the CPU
     */
    @Override
    public void runCode(final CPU cpu) {
        ...
        final ICPULcdBaseCallback command = cpu.getPIOContext().getLcd().getCommandCallback();
        ((IDevice) command).runCode(cpu);
    }
