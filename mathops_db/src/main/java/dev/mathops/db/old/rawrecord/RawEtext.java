...
public final class RawEtext extends RecBase implements Comparable<RawEtext> {
    ...
    /**
     * Constructs a new {@code RawEtext} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawEtext parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_ETEXT_ID.equals(name)) {
            this.etextId = value;
        } else if (FLD_RETENTION.equals(name)) {
            this.retention = value;
        } else if (FLD_PURCHASE_URL.equals(name)) {
            this.purchaseUrl = value;
        } else if (FLD_REFUND_PERIOD.equals(name)) {
            this.refundPeriod = Integer.valueOf(value);
        } else if (FLD_KEY_ENTRY.equals(name)) {
            this.keyEntry = value;
