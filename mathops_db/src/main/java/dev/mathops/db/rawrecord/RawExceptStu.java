...
public final class RawExceptStu extends RawTermRecordBase implements Comparable<RawExceptStu> {
    ...
    /**
     * Constructs a new {@code RawExceptStu} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawExceptStu parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_COURSE_ENROLL.equals(name)) {
            this.courseEnroll = value;
        } else if (FLD_HWORK_STATUS.equals(name)) {
            this.hworkStatus = value;
        } else if (FLD_SECT.equals(name)) {
            this.sect = value;
        } else if (FLD_SECT_ENROLL.equals(name)) {
            this.sectEnroll = value;
        }
    }
