...
/**
 * Constructs the "problem_author.jar" app JAR file.
 *
 * <p>
 ...
 * </pre>
 */
final class ProblemAuthorJarBuilder {
    ...
    /**
     * Constructs a new {@code ProblemAuthorJarBuilder}.
     */
    private ProblemAuthorJarBuilder() {
    ...
    private void build() {
        ...
        if (success) {
            try (final FileOutputStream out = new FileOutputStream(new File(jars, "problem_author.jar"));
                ...
                jar.finish();
                Log.finest(Res.fmt(Res.JAR_DONE, "problem_author"), CoreConstants.CRLF);
    ...
    private static void addManifest(final JarOutputStream jar) throws IOException {
        ...
        htm.addln("Created-By: ProblemAuthorJarBuilder 1.01");
        htm.addln("Main-Class: edu.colostate.math.system.assessment.app.problemauthor.ProblemAuthor");
        htm.addln("Class-Path: flatlaf-3.0.jar");
    ...
    public static void main(final String... args) {
        ...
        new ProblemAuthorJarBuilder().build();
