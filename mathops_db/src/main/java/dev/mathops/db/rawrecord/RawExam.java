...
public final class RawExam extends RecBase implements Comparable<RawExam> {
    ...
    /**
     * Constructs a new {@code RawExam} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawExam parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_VSN_EXPLT.equals(name)) {
            this.vsnExplt = value;
        ...
        } else if (FLD_PULL_DT.equals(name)) {
            this.pullDt = LocalDate.parse(value);
