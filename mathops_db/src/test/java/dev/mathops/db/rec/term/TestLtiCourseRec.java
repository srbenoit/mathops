...
/**
 * Tests for the {@code LtiCourseRec} class.
 */
final class TestLtiCourseRec {
    ...
    void test0001() {
        ...
        final LtiCourseRec obj = new LtiCourseRec(TEST_CLIENT_ID, TEST_ISSUER, TEST_DEPLOYMENT_ID, TEST_CONTEXT_ID,
                TEST_LMS_COURSE_ID, TEST_LMS_COURSE_TITLE, TEST_COURSE_ID, TEST_SECTION_NBR);
