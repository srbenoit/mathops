...
/**
 * The "rlc_ind_reverse_info" opcode.
 */
public final class RlcIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code RlcIndReverseInfo}.
     */
    public RlcIndReverseInfo() {

        // No action
    }

    /**
     * Opcode rlc_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "rlc_ind_reverse_info" function.
     */
    @Override
