...
public final class RawClientPc extends RecBase implements Comparable<RawClientPc> {
    ...
    /**
     * Constructs a new {@code RawClientPc} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawClientPc parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_COMPUTER_ID.equals(name)) {
            this.computerId = value;
        } else if (FLD_TESTING_CENTER_ID.equals(name)) {
            this.testingCenterId = value;
        } else if (FLD_STATION_NBR.equals(name)) {
            this.stationNbr = value;
        } else if (FLD_COMPUTER_DESC.equals(name)) {
            this.computerDesc = value;
        } else if (FLD_ICON_X.equals(name)) {
            this.iconX = Integer.valueOf(value);
        } else if (FLD_ICON_Y.equals(name)) {
            this.iconY = Integer.valueOf(value);
        } else if (FLD_PC_USAGE.equals(name)) {
            this.pcUsage = value;
        } else if (FLD_CURRENT_STATUS.equals(name)) {
            this.currentStatus = Integer.valueOf(value);
        } else if (FLD_DTIME_CREATED.equals(name)) {
            this.dtimeCreated = LocalDateTime.parse(value);
        } else if (FLD_DTIME_APPROVED.equals(name)) {
            this.dtimeApproved = LocalDateTime.parse(value);
        } else if (FLD_MAC_ADDRESS.equals(name)) {
            this.macAddress = value;
        } else if (FLD_POWER_STATUS.equals(name)) {
            this.powerStatus = value;
        } else if (FLD_POWER_ON_DUE.equals(name)) {
            this.powerOnDue = Integer.valueOf(value);
        } else if (FLD_LAST_PING.equals(name)) {
            this.lastPing = Integer.valueOf(value);
        } else if (FLD_CURRENT_STU_ID.equals(name)) {
            this.currentStuId = value;
        } else if (FLD_CURRENT_COURSE.equals(name)) {
            this.currentCourse = value;
        } else if (FLD_CURRENT_UNIT.equals(name)) {
            this.currentUnit = Integer.valueOf(value);
        } else if (FLD_CURRENT_VERSION.equals(name)) {
