 ...
 */
public final class FESwitch extends AbstractFEObject {
     ...
     */
    public FESwitch(final int theFontSize) {
     ...
     */
    private void setCondition(final AbstractFEObject newCondition, final boolean storeUndo) {
     ...
     * @param storeUndo     true to store an undo state; false to skip
     */
    private void setThenClause(final AbstractFEObject newThenClause, final boolean storeUndo) {
     ...
     * @param storeUndo     true to store an undo state; false to skip
     */
    private void setElseClause(final AbstractFEObject newElseClause, final boolean storeUndo) {
    ...
    private void processCharEmptyConditionSlot(final FECursor cursor, final char ch) {
        ...
        if ((int) ch == '{') {
            ...
            ++cursor.cursorPosition;
            final FESwitch test = new FESwitch(fontSize);
    ...
    private void processCharEmptyThenElseSlot(final FECursor cursor, final char ch, final boolean isThen) {
        ...
        final EnumSet<EType> actualAllowed = isThen ? getTypesAllowedForThen() : getTypesAllowedForElse();
     ...
     */
    @Override
    public FESwitch duplicate() {

        final int fontSize = getFontSize();
        final FESwitch dup = new FESwitch(fontSize);
