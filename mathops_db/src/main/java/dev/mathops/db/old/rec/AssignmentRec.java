...
public final class AssignmentRec extends RecBase implements Comparable<AssignmentRec> {
    ...
    /** A field name for serialization of records. */
    public static final String FLD_OBJECTIVE = "objective";
    ...
    /** A field name for serialization of records. */
    public static final String FLD_WHEN_ACTIVE = "when_active";

    /** A field name for serialization of records. */
    public static final String FLD_WHEN_PULLED = "when_pulled";
