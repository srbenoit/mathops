 ...
 */
public interface IInformixRecLogic<T extends RecBase> extends IRecLogic<T> {
     ...
     */
    default String stringWhere(final HtmlBuilder stmt, final String where, final String fieldName,
     ...
     * @return the new prefix ({@code where} if no clause was emitted, " AND " if a clause was emitted)
     */
    default String integerWhere(final HtmlBuilder stmt, final String where, final String fieldName,
                                final IntegerCriteria criteria) {
