 ...
 * </pre>
 */
public final class RawAdminHoldLogic extends AbstractRawLogic<RawAdminHold> {

    /** A single instance. */
    public static final RawAdminHoldLogic INSTANCE = new RawAdminHoldLogic();

    /** Empty list to return when there are no records. */
    private static final List<RawAdminHold> EMPTY_LIST =
    ...
    static {
        STAFF_HOLD_MSG.put("01",
                "unauthorized grading option selected by student - have student "
                        + "talk w/ director");
        STAFF_HOLD_MSG.put("02",
                "warn student they are registered for more than recommended # of "
                        + "courses in SM");
        ...
        STAFF_HOLD_MSG.put("06",
                "discretionary administrative hold -- have student speak with a "
                        + "director");
        STAFF_HOLD_MSG.put("07",
                "Profile info specifies different registrtion format than is in "
                        + "STUDENT record");
        ...
        STAFF_HOLD_MSG.put("10",
                "student has mixed instr and stu managed courses, registering "
                        + "thru both RI and CE");
        ...
        STAFF_HOLD_MSG.put("13",
                "licensed, but not registered in section for which batch exam was "
                        + "administered");
        STAFF_HOLD_MSG.put("14",
                "duplicate RI & CE registration for same course -- CHECK ARIES!");
        STAFF_HOLD_MSG.put("15",
                "User's survey says student is taking both stu managed and "
                        + "instructor led");
        ...
        STAFF_HOLD_MSG.put("19",
                "not licensed and not registered in sect for which batch exam was "
                        + "administered");
        STAFF_HOLD_MSG.put("20",
                "course prereq not satisfied for an exam taken during a batch "
                        + "administration");
        STAFF_HOLD_MSG.put("21",
                "tried to create stcourse record after deadline date based on "
                        + "User's survey");
        STAFF_HOLD_MSG.put("22",
                "tried to create stu managed stcourse rowafter add deadline "
                        + "date so not registerd");
        STAFF_HOLD_MSG.put("23",
                "officially registered for two different Precalculus formats -- "
                        + "needs to change registration");
        ...
        STAFF_HOLD_MSG.put("29",
                "*** M120B student who is also registeredfor another minicourse -- "
                        + "PROBLEM!!! ***");
        ...
        STAFF_HOLD_MSG.put("33",
                "student may have lost personal items -- check lost/found box & ask "
                        + "director");
        STAFF_HOLD_MSG.put("34",
                "have student talk with Anita (or Steve)");
        STAFF_HOLD_MSG.put("36",
                "REMIND STUDENT: their RENTAL CALC needs to be returned by the last "
                        + "day of finals");
        STAFF_HOLD_MSG.put("41",
                "student has an OVERDUE IN-HOUSE VIDEO --ask to return immediately!");
        STAFF_HOLD_MSG.put("42",
                "student has an OVERDUE IN-HOUSE TEXT -- ask to return it or check it "
                        + "out again");
        STAFF_HOLD_MSG.put("43",
                "student has a LATE OVERNIGHT VIDEO -- ask to return by the end of the "
                        + "day!");
        STAFF_HOLD_MSG.put("44",
                "student has a LATE OVERNIGHT TEXTBOOK -- ask to return by the end of "
                        + "the day!");
        ...
        STAFF_HOLD_MSG.put("47",
                "student has an OVERDUE RENTAL CALC MANUAL -- must be returned "
                        + "immediately!");
        STAFF_HOLD_MSG.put("48",
                "Student has rented a calc --> SEND TO OFFICE for copy of RENTAL "
                        + "AGREEMENT");
        STAFF_HOLD_MSG.put("49",
                "Student needs to get a new CSU ID card because we cannot identify "
                        + "properly");
        STAFF_HOLD_MSG.put("50",
                "FINAL WARNING to student: return TI-83 calc or be billed $100 "
                        + "replacement fee");
        ...
        STUDENT_HOLD_MSG.put("02",
                "You are registered for more courses than we recommend for the Summer "
                        + "term.  We advise you to work during the full 12 week Summer "
                        + "Session to complete all five courses.");
        STUDENT_HOLD_MSG.put("03",
                "You have registered for both the PLACEMENT CREDIT AND REGULAR sections "
                        + "of the same class - please fix your registration by withdrawing "
                        + "from sect 001");
        STUDENT_HOLD_MSG.put("06",
                "There is a problem that requires you speak with a director "
                        + "immediately.");
        STUDENT_HOLD_MSG.put("07",
                "Your Profile responses do not match the Registrar's information "
                        + "provided to us.");
        STUDENT_HOLD_MSG.put("14",
                "you have registered for the same course through RamWeb and CSU "
                        + "Online - please  fix your registration (sections 001 & 801)");
        STUDENT_HOLD_MSG.put("15",
                "Your Profile says you are taking both student managed and instructor "
                        + "led classes");
        ...
        STUDENT_HOLD_MSG.put("18",
                "You submitted a Math Placement attempt when you had no remaining "
                        + "attempts.");
        STUDENT_HOLD_MSG.put("21",
                "It is too late to register for one of   the courses you listed in "
                        + "your Profile");
        ...
        STUDENT_HOLD_MSG.put("27",
                "You have registered for placement credit but are not eligible for "
                        + "that credit");
        STUDENT_HOLD_MSG.put("30",
                "By missing weekly progress, you are locked out of working on your "
                        + "Precalculus courses");
        STUDENT_HOLD_MSG.put("31",
                "You must speak with a Precalculus Center director as soon as "
                        + "poossible (Weber 137)");
        STUDENT_HOLD_MSG.put("32",
                "We have your CSU ID card in the Precalculus Center (Weber 137).  "
        ...
        STUDENT_HOLD_MSG.put("46",
                "You have an OVERDUE RENTAL CALC -- it needs to be returned "
                        + "immediately!");
        STUDENT_HOLD_MSG.put("47",
                "You have OVERDUE RENTAL CALC MANUAL that must be returned immediately!");
        STUDENT_HOLD_MSG.put("48",
                "Pick up your copy of the TI-83 calculator rental agreement in the "
                        + "Precalculus Center");
        STUDENT_HOLD_MSG.put("49",
                "You need to get a new CSU ID; it is not possible to fully identify "
                        + "you from ID");
        STUDENT_HOLD_MSG.put("50",
                "FINAL WARNING: return the TI-84 calculator immediately that you "
                        + "borrowed from the Resource Desk, or you will be billed a $100 "
                        + "replacement fee.");
     ...
     */
    @Override
    public boolean insert(final Cache cache, final RawAdminHold record) throws SQLException {
     ...
     */
    @Override
    public boolean delete(final Cache cache, final RawAdminHold record) throws SQLException {
     ...
     */
    @Override
    public List<RawAdminHold> queryAll(final Cache cache) throws SQLException {
    ...
    public static List<RawAdminHold> queryByStudent(final Cache cache, final String stuId) throws SQLException {
        ...
        if (stuId.startsWith("99")) {
            ...
            final String sql = SimpleBuilder.concat(
                    "SELECT * FROM admin_hold WHERE stu_id=", sqlStringValue(stuId));
    ...
    public static int deleteAllByHoldId(final Cache cache, final String holdId) throws SQLException {
        ...
        sql.add("DELETE FROM admin_hold ",
                " WHERE hold_id=", sqlStringValue(holdId));
