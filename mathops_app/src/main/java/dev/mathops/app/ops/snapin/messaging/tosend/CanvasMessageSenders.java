...
public final class CanvasMessageSenders {
    ...
    /** The host address for Canvas. */
    private static final String CANVAS_HOST = "https://colostate.instructure.com";
    ...
    public CanvasMessageSenders(final Cache theCache, final String accessToken) {
        ...
        // FIXME: Configured these correctly each Fall, Spring, and Summer term

        final CanvasMessageSend sender117ri = new CanvasMessageSend(theCache, CANVAS_HOST,
        ...
        final CanvasMessageSend sender117ce = new CanvasMessageSend(theCache, CANVAS_HOST,
...
//        senders117.put("809", sender117ce);
        ...
        final CanvasMessageSend sender118ri = new CanvasMessageSend(theCache, CANVAS_HOST,
        ...
        final CanvasMessageSend sender118ce = new CanvasMessageSend(theCache, CANVAS_HOST,
...
//        senders118.put("809", sender118ce);
        ...
        final CanvasMessageSend sender124ri = new CanvasMessageSend(theCache, CANVAS_HOST,
        ...
        final CanvasMessageSend sender124ce = new CanvasMessageSend(theCache, CANVAS_HOST,
...
//        senders124.put("809", sender124ce);
        ...
        final CanvasMessageSend sender125ri = new CanvasMessageSend(theCache, CANVAS_HOST,
        ...
        final CanvasMessageSend sender125ce = new CanvasMessageSend(theCache, CANVAS_HOST,
...
//        senders125.put("809", sender125ce);
        ...
        final CanvasMessageSend sender126ri = new CanvasMessageSend(theCache, CANVAS_HOST,
        ...
        final CanvasMessageSend sender126ce = new CanvasMessageSend(theCache, CANVAS_HOST,
