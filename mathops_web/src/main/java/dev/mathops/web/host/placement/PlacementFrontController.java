...
/**
 * The front controller for the "placement.[domain]" host.
 *
 * <p>
 ...
 */
public final class PlacementFrontController extends HttpServlet {
    ...
    private IMidController placementMidController = null;
     ...
     */
    public PlacementFrontController() {
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        this.placementMidController = new PlacementMidController(config);
    ...
    private void serviceSecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.placementMidController.serviceSecure(req, resp, requestPath);
        }
    }
    ...
    private void serviceInsecure(final String requestPath, final HttpServletRequest req,
        ...
        if (requestPath.startsWith(PUBLIC_PATH_START)) {
            ...
            this.placementMidController.serviceInsecure(req, resp, requestPath);
        }
    }
