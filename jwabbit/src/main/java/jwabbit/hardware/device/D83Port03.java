...
/**
 * The port 3 device for the TI 83 hardware.
 */
public final class D83Port03 extends AbstractDevice {

    /** The STDINT to which this device interfaces. */
    private STDINT stdint;

    /**
     * Constructs a new {@code Device83Port03}.
     *
     * @param theDevIndex the index at which this device is installed
     */
    public D83Port03(final int theDevIndex) {
    ...
    /**
     * WABBITEMU SOURCE: hardware/83hw.c, "port03_83" function.
     *
     * @param cpu the CPU
     */
    @Override
