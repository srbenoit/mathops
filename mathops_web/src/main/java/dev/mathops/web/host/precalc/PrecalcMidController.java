...
/**
 * A mid-controller that handles requests to the "precalc.[domain]" host whose request paths don't begin with "/www/".
 */
public final class PrecalcMidController implements IMidController {
     ...
     */
    PrecalcMidController(final ServletConfig config) throws ServletException {
