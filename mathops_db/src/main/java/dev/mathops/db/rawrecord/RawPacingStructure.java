...
public final class RawPacingStructure extends RawTermRecordBase implements Comparable<RawPacingStructure> {
    ...
    /**
     * Constructs a new {@code RawPacingStructure} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawPacingStructure parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_DEF_PACE_TRACK.equals(name)) {
            this.defPaceTrack = value;
        } else if (FLD_REQUIRE_LICENSED.equals(name)) {
            this.requireLicensed = value;
        } else if (FLD_REQUIRE_PARTIC.equals(name)) {
            this.requirePartic = value;
        } else if (FLD_MAX_PARTIC_MISSED.equals(name)) {
            this.maxParticMissed = Integer.valueOf(value);
        } else if (FLD_ALLOW_INC.equals(name)) {
            this.allowInc = value;
        } else if (FLD_MAX_COURSES.equals(name)) {
            this.maxCourses = Integer.valueOf(value);
        } else if (FLD_NBR_OPEN_ALLOWED.equals(name)) {
            this.nbrOpenAllowed = Integer.valueOf(value);
        } else if (FLD_REQUIRE_UNIT_EXAMS.equals(name)) {
            this.requireUnitExams = value;
        } else if (FLD_USE_MIDTERMS.equals(name)) {
            this.useMidterms = value;
        } else if (FLD_ALLOW_COUPONS.equals(name)) {
            this.allowCoupons = value;
        } else if (FLD_COUPONS_AFTER_WINDOW.equals(name)) {
            this.couponsAfterWindow = value;
        } else if (FLD_USERS_PROGRESS_CR.equals(name)) {
            this.usersProgressCr = Integer.valueOf(value);
        } else if (FLD_HW_PROGRESS_CR.equals(name)) {
            this.hwProgressCr = Integer.valueOf(value);
        } else if (FLD_RE_PROGRESS_CR.equals(name)) {
            this.reProgressCr = Integer.valueOf(value);
        } else if (FLD_UE_PROGRESS_CR.equals(name)) {
            this.ueProgressCr = Integer.valueOf(value);
        } else if (FLD_FIN_PROGRESS_CR.equals(name)) {
            this.finProgressCr = Integer.valueOf(value);
        } else if (FLD_PACING_NAME.equals(name)) {
            this.pacingName = value;
        } else if (FLD_SCHEDULE_SOURCE.equals(name)) {
            this.scheduleSource = value;
        } else if (FLD_SR_DUE_DATE_ENFORCED.equals(name)) {
            this.srDueDateEnforced = value;
        } else if (FLD_RE_DUE_DATE_ENFORCED.equals(name)) {
            this.reDueDateEnforced = value;
        } else if (FLD_UE_DUE_DATE_ENFORCED.equals(name)) {
            this.ueDueDateEnforced = value;
        } else if (FLD_FE_DUE_DATE_ENFORCED.equals(name)) {
            this.feDueDateEnforced = value;
        } else if (FLD_FIRST_OBJ_AVAIL.equals(name)) {
            this.firstObjAvail = value;
        }
    }
     ...
     * @param theRequireLicensed    the "Y" if requires student be licensed; "N" if not
    ...
    public int hashCode() {
        ...
        return EqualityTests.objectHashCode(this.termKey)
                ...
                + EqualityTests.objectHashCode(this.defPaceTrack)
                + EqualityTests.objectHashCode(this.requireLicensed)
                + EqualityTests.objectHashCode(this.requirePartic)
                + EqualityTests.objectHashCode(this.maxParticMissed)
                + EqualityTests.objectHashCode(this.allowInc)
                + EqualityTests.objectHashCode(this.maxCourses)
                + EqualityTests.objectHashCode(this.nbrOpenAllowed)
                + EqualityTests.objectHashCode(this.requireUnitExams)
                + EqualityTests.objectHashCode(this.useMidterms)
                + EqualityTests.objectHashCode(this.allowCoupons)
                + EqualityTests.objectHashCode(this.couponsAfterWindow)
                + EqualityTests.objectHashCode(this.usersProgressCr)
                + EqualityTests.objectHashCode(this.hwProgressCr)
                + EqualityTests.objectHashCode(this.reProgressCr)
                + EqualityTests.objectHashCode(this.ueProgressCr)
                + EqualityTests.objectHashCode(this.finProgressCr)
                + EqualityTests.objectHashCode(this.pacingName)
                + EqualityTests.objectHashCode(this.scheduleSource)
                + EqualityTests.objectHashCode(this.srDueDateEnforced)
                + EqualityTests.objectHashCode(this.reDueDateEnforced)
                + EqualityTests.objectHashCode(this.ueDueDateEnforced)
                + EqualityTests.objectHashCode(this.feDueDateEnforced)
                + EqualityTests.objectHashCode(this.firstObjAvail);
    }
