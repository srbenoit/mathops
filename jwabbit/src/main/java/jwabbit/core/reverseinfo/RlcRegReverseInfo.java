...
/**
 * The "rlc_reg_reverse_info" opcode.
 */
public final class RlcRegReverseInfo implements IRevOpcode {

    /**
     * Constructs a new {@code RlcRegReverseInfo}.
     */
    public RlcRegReverseInfo() {

        // No action
    }

    /**
     * Opcode rlc_reg_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "rlc_reg_reverse_info" function.
     */
    @Override
