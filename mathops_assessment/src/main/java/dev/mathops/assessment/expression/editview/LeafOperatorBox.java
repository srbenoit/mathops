 ...
 */
public final class LeafOperatorBox extends AbstractObjectBox {

    /** The source object. */
    private final ExprLeafOperator source;
    ...
    /**
     * Constructs a new {@code LeafOperatorBox}.
     *
     * @param theSource the source object
     * @param currentFontSize the current font size
     */
    LeafOperatorBox(final ExprLeafOperator theSource, final float currentFontSize) {
        ...
        final EOperatorSymbol oper = theSource.getOperator();

        final FontMetrics metrics = Fonts.g2d.getFontMetrics(this.font);
        final int w = metrics.stringWidth(oper.str);
        setWidth(w);

        final GlyphVector gvector = this.font.createGlyphVector(Fonts.frc, oper.str);
    ...
    public void paint(final Graphics2D g2d) {
        ...
        final EOperatorSymbol oper = this.source.getOperator();

        g2d.setColor(this.color);
        g2d.setFont(this.font);
        g2d.drawString(oper.str, this.x, this.y);
    }
    ...
    public String toString() {
        ...
        return SimpleBuilder.concat("LeafOperatorBox{source=", this.source, ", font=", this.font, ", color=",
                this.color, "}");
    }
}
