...
public final class RawHoldType extends RecBase implements Comparable<RawHoldType> {
    ...
    /**
     * Constructs a new {@code RawHoldType} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawHoldType parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_HOLD_ID.equals(name)) {
            this.holdId = value;
        } else if (FLD_SEV_ADMIN_HOLD.equals(name)) {
            this.sevAdminHold = value;
        } else if (FLD_HOLD_TYPE.equals(name)) {
            this.holdType = value;
        } else if (FLD_ADD_HOLD.equals(name)) {
            this.addHold = value;
        } else if (FLD_DELETE_HOLD.equals(name)) {
            this.deleteHold = value;
        }
    }
    ...
    /**
     * Extracts an "hold_type" record from a result set.
     *
