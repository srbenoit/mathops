...
class AreYouFinished extends AbstractInternalDialogBase {
    ...
    AreYouFinished(final int numProblems, final int numCompleted, final ActionListener theListener) {
        ...
        setResOwner(this);
        final Properties res = FileLoader.loadFileAsProperties(AreYouFinished.class, //
                "AreYouFinishedSkin", new DefaultAreYouFinishedSkin(), false);
     ...
     * @return {@code true}to accept the command, false to veto the command
     */
    @Override
 ...
 */
class DefaultAreYouFinishedSkin extends Properties {

    /** Version number for serialization. */
    @Serial
    private static final long serialVersionUID = 6041068751378053121L;
    ...
    private static final String[][] CONTENTS = {//
            ...
            {"line1-font-size", "16"},
            {"line1-font-style", "BOLD"}, // $   NON-NLS-1$
    ...
    /**
     * Construct a new {@code DefaultAreYouFinishedSkin} properties object.
     */
