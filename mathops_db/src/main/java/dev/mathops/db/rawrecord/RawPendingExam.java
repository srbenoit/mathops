...
public final class RawPendingExam extends RecBase implements Comparable<RawPendingExam> {
    ...
    /**
     * Constructs a new {@code RawPendingExam} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawPendingExam parse(final String toParse) {
