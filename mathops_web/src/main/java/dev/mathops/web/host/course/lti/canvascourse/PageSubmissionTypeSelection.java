...
/**
 * A page with the "submission_type_selection" placement.
 */
enum PageSubmissionTypeSelection {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Submission Type Selection");
        }
    }
}
