...
/**
 * An instance of an input that supports the entry of an integer value. The input control allows definition of all
 * document formatting characteristics. Integer fields are drawn in a shaded outline, which highlights when the object
 * is selected. When selected, a text edit caret is shown and editing is supported.
 */
public final class DocInputLongFieldInst extends AbstractDocInputFieldInst {
    ...
    private final Long minusAs;

    /**
     * Construct a new {@code DocInputLongFieldInst}.
     *
     ...
     */
    public DocInputLongFieldInst(final DocObjectInstStyle theStyle, final String theBgColorName, final String theName,
                                 final String theEnabledVarName, final Object theEnabledVarValue,
                                 final EFieldStyle theFieldStyle, final int theWidth, final Long theDefaultValue,
                                 final Long theMinusAs) {
    ...
    public String toString() {
        ...
        builder.add("DocInputLongFieldInst");
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == this) {
            equal = true;
        } else if (obj instanceof final DocInputLongFieldInst field) {
