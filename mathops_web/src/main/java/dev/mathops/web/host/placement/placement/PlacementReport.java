...
public final class PlacementReport {
     ...
     * @param includeNextSteps true to include a "what should I do next?" section
     * @param htm              the {@code HtmlBuilder} to which to append the HTML
     * @throws SQLException if there is an error accessing the database
     */
    public static void doPlacementReport(final Cache cache, final PlacementStatus status,
                                         final ImmutableSessionInfo session, final String title,
                                         final boolean includeNextSteps, final HtmlBuilder htm) throws SQLException {
        ...
        if (status.attemptsUsed == 0) {
            ...
            for (final String course : status.clearedFor) {
                ...
                if (heading) {
                    heading = false;
                    htm.sP("indent11");
                    htm.add(" <img src='/images/check.png'/> &nbsp; You are cleared to register for: ");
                }
                ...
                if (!("MATH 101".equals(course) || "MATH 105".equals(course) || "MATH 112".equals(course)
                      || "STAT 100".equals(course) || "STAT 201".equals(course) || "STAT 204".equals(course)
                      || "FIN 200".equals(course))) {
                    noneButAucc = false;
                }
            }
            ...
            for (final String course : status.placedOutOf) {
                ...
                if (heading) {
                    heading = false;
                    htm.sP("indent11");
                    htm.add(" <img src='/images/check.png'/> &nbsp; You have placed out of: ");
                }
            ...
            for (final String course : status.earnedCreditFor) {
                ...
                if (heading) {
                    heading = false;
                    htm.sP("indent11");
                    htm.add(" <img src='/images/check.png'/> &nbsp; You have earned challenge credit for: ");
                }
            ...
            if (noneButAucc) {
                ...
                if (includeNextSteps) {
                    ...
                    if (status.attemptsRemaining > 0) {
                        ...
                        htm.sP("indent2");
                        htm.add("Alternately, to become eligible to register for just MATH 117 or MATH 120, you may ",
