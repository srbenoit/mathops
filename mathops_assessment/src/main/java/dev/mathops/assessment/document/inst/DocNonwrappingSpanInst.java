 ...
 * paragraphs.
 */
public final class DocNonwrappingSpanInst extends AbstractDocContainerInst {

    /**
     * Construct a new {@code DocNonwrappingSpanInst}.
     *
     ...
     */
    public DocNonwrappingSpanInst(final DocObjectInstStyle theStyle, final String theBgColorName,
    ...
    public String toString() {
        ...
        builder.add("DocNonwrappingSpanInst");
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == this) {
            equal = true;
        } else if (obj instanceof final DocNonwrappingSpanInst nonwrap) {
            equal = checkDocContainerInstEquals(nonwrap);
        } else {
            equal = false;
        }
