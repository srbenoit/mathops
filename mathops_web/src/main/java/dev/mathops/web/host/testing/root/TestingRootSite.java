 ...
 */
public final class TestingRootSite extends AbstractSite {
    ...
    /**
     * Constructs a new {@code TestingRootSite}.
     *
     * @param theSite     the context under which this site is accessed
     * @param theSessions the singleton user session repository
     */
    public TestingRootSite(final Site theSite, final ISessionManager theSessions) {
    ...
    public void doGet(final Cache cache, final String subpath, final ESiteType type,
        ...
        if (STYLE_CSS.equals(subpath)) {
            final Class<? extends TestingRootSite> myClass = getClass();
            final byte[] styleBytes = FileLoader.loadFileAsBytes(myClass, STYLE_CSS, true);
