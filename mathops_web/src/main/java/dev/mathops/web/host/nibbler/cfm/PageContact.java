...
enum PageContact {
    ...
    static void showPage(final Cache cache, final CfmSite site, final ServletRequest req,
        ...
        Page.startOrdinaryPage(htm, "The Center for Foundational Mathematics - Contact Us", null, true, 0, null, false,
                false);

        PageUtilities.emitSubpageTitle(htm, "Contact Us", "contact.svg");
