...
public final class RawStsurveyqa extends RecBase implements Comparable<RawStsurveyqa> {
    ...
    /**
     * Constructs a new {@code RawStsurveyqa} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStsurveyqa parse(final String toParse) {
    ...
    /**
     * Extracts an "stsurveyqa" record from a result set.
     *
