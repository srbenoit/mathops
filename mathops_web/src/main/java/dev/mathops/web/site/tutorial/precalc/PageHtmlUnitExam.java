...
enum PageHtmlUnitExam {
     ...
     */
    static void startUnitExam(final Cache cache, final PrecalcTutorialSite site, final ServletRequest req,
     ...
     * @throws SQLException if there is an error accessing the database
     */
    static void updateUnitExam(final Cache cache, final PrecalcTutorialSite site,
