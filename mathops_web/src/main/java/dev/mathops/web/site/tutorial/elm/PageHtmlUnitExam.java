...
enum PageHtmlUnitExam {
     ...
     */
    static void startUnitExam(final Cache cache, final ElmTutorialSite site,
     ...
     * @throws SQLException if there is an error accessing the database
     */
    static void updateUnitExam(final Cache cache, final ElmTutorialSite site, final ServletRequest req,
