...
/**
 * The "rrc_ind_reverse_info" opcode.
 */
public final class RrcIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code RrcIndReverseInfo}.
     */
    public RrcIndReverseInfo() {

        // No action
    }

    /**
     * Opcode rrc_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "rrc_ind_reverse_info" function.
     */
    @Override
