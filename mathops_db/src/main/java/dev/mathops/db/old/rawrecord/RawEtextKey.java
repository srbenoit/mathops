...
public final class RawEtextKey extends RecBase implements Comparable<RawEtextKey> {
    ...
    /**
     * Constructs a new {@code RawEtextKey} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawEtextKey parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_ETEXT_ID.equals(name)) {
            ...
            this.activeDt = LocalDateTime.parse(value);
        }
    }
