...
public final class RawTreePath extends RecBase implements Comparable<RawTreePath> {
    ...
    /**
     * Constructs a new {@code RawTreePath} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawTreePath parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_IDENT.equals(name)) {
            this.ident = value;
        } else if (FLD_PARENT_IDENT.equals(name)) {
            this.parentIdent = value;
        } else if (FLD_DEPTH.equals(name)) {
            this.depth = Integer.valueOf(value);
        } else if (FLD_SORT_ORDER.equals(name)) {
            this.sortOrder = Integer.valueOf(value);
        } else if (FLD_LABEL.equals(name)) {
            this.label = value;
        }
    }
