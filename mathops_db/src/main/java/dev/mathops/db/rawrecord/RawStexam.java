...
public final class RawStexam extends RecBase implements Comparable<RawStexam> {
    ...
    /**
     * Constructs a new {@code RawStexam} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStexam parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_EXAM_SCORE.equals(name)) {
            this.examScore = Integer.valueOf(value);
        } else if (FLD_MASTERY_SCORE.equals(name)) {
            this.masteryScore = Integer.valueOf(value);
        ...
        } else if (FLD_EXAM_TYPE.equals(name)) {
            this.examType = value;
        } else if (FLD_IS_FIRST_PASSED.equals(name)) {
            this.isFirstPassed = value;
        } else if (FLD_EXAM_SOURCE.equals(name)) {
            this.examSource = value;
        } else if (FLD_CALC_NBR.equals(name)) {
            this.calcNbr = value;
        }
    }
    ...
    /**
     * Extracts an "stexam" record from a result set.
     *
