...
enum PageProctoringChallengeTeams {
     ...
     */
    private static void doPageContent(final HtmlBuilder htm, final String stuId) {
        ...
        htm.addln("<li>Paste this into the student's browser address bar:<br> ",
                ...
                "https://course.math.colostate.edu/lti/onlineproctorchallenge.html</code></li>");
