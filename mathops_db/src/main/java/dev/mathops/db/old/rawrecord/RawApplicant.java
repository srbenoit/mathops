...
public final class RawApplicant extends RecBase implements Comparable<RawApplicant> {
    ...
    /**
     * Constructs a new {@code RawApplicant} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawApplicant parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_STU_ID.equals(name)) {
            ...
            this.college = value;
        } else if (FLD_PROG_STUDY.equals(name)) {
            this.progStudy = value;
            ...
            this.resident = value;
        } else if (FLD_RESIDENT_STATE.equals(name)) {
            this.residentState = value;
        } else if (FLD_RESIDENT_COUNTY.equals(name)) {
