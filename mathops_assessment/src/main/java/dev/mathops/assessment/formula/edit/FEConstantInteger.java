...
/**
 * A container for an Int constant that can generate an {@code IntegerValue}.
 */
public final class FEConstantInteger extends AbstractFEObject {
    ...
    /**
     * Constructs a new {@code FEConstantInteger}.
     *
     * @param theFontSize the font size for the component
     */
    public FEConstantInteger(final int theFontSize) {

        super(theFontSize);

        getAllowedTypes().add(EType.INTEGER);
        getPossibleTypes().add(EType.INTEGER);
     ...
     */
    public FEConstantInteger(final int theFontSize, final long theValue) {
     ...
     */
    private void setValue(final long theValue, final boolean storeUndo) {

        this.value = Long.valueOf(theValue);
        this.text = Long.toString(theValue);
        update(storeUndo);
    }
    ...
    public void setText(final String theText, final boolean storeUndo) {
        ...
        try {
            this.value = Long.valueOf(this.text);
    ...
    public void processChar(final FECursor fECursor, final char ch) {
        ...
        // TODO: Allow "times 10 to the ___" with positive powers?
    ...
    public String processInsert(final FECursor fECursor, final AbstractFEObject toInsert) {
        ...
        return "Cannot insert object into integer value.";
    }
