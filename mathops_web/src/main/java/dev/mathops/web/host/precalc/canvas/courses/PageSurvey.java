...
/**
 * This page shows the "Survey" content.
 */
public enum PageSurvey {
    ;
    ...
    public static void doGet(final Cache cache, final CanvasSite site, final String courseId, final ServletRequest req,
        ...
        if (registration == null) {
            ...
            if (course == null) {
                ...
                presentSurvey(cache, site, req, resp, session, registration, course);
            }
        }
    }

    /**
     * Presents the "Survey" information.
     *
     * @param cache        the data cache
     * @param site         the owning site
     * @param req          the request
     ...
     * @throws SQLException if there is an error accessing the database
     */
    static void presentSurvey(final Cache cache, final CanvasSite site, final ServletRequest req,
        ...
        if (section == null) {
            ...
            CanvasPageUtils.emitLeftSideMenu(htm, course, null, ECanvasPanel.COURSE_SURVEY);
