...
/**
 * A page with the "assignment_group_menu" placement.
 */
enum PageAssignmentGroupMenu {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Assignment Group Menu");
        }
    }
}
