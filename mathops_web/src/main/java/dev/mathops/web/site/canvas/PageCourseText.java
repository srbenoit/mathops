...
//            CourseMenu.buildMenu(cache, site, session, logic, htm);
     ...
     * @param htm           the {@code HtmlBuilder} to which to append the HTML
     */
    private static void doCourseText(final ImmutableSessionInfo session, final CourseData courseData,
                                     final CourseSiteLogic logic, final StdsMasteryStatus masteryStatus,
                                     final String mode, final HtmlBuilder htm) {
     ...
     *         to open the module
     */
    private static String isModuleOpen(final ImmutableSessionInfo session, final StdsMasteryStatus status,
