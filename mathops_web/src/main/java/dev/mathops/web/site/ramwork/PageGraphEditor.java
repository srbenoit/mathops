        ...
        htm.addln("""
                ...
                function insertNumberLine() {
                    var toInsert = "<graphxy width='800' height='50' axiswidth='0' xaxislabel='' yaxislabel='' "
                      ...
                      + "\\n"
                      + "  <line x='10' y='20' width='780' height='0' stroke-width='2'/>\\n"
                      + "  <polygon x-list='0,16,16' y-list='20,13,27' filled='TRUE'/>\\n"
                      + "  <polygon x-list='800,784,784' y-list='20,13,27' filled='TRUE'/>\\n"
                      + "\\n"
                      + "  <function-plot color='blue3' stroke-width='4' minx='-3' maxx='2'>\\n"
                      + "    <expr><integer value='0'/></expr>\\n"
                      + "  </function-plot>\\n"
                      + "\\n"
                      + "  <oval x='190' y='12' width='16' height='16' filled='true' color='blue3'/>\\n"
                      + "  <oval x='528' y='12' width='16' height='16' filled='true' color='blue3'/>\\n"
                      + "  <oval x='532' y='16' width='8' height='8' filled='true' color='white'/>\\n"
                      + "\\n"
                      + "</graphxy>";
                    insertAtCursor(toInsert);
                }
