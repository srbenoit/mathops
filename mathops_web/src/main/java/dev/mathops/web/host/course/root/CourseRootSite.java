 ...
 */
public final class CourseRootSite extends AbstractSite {
    ...
    /**
     * Constructs a new {@code CourseRootSite}.
     *
     * @param theSite     the context under which this site is accessed
     * @param theSessions the singleton user session repository
     */
    public CourseRootSite(final Site theSite, final ISessionManager theSessions) {
