...
/**
 * A page with the "discussion_topic_menu" placement.
 */
enum PageDiscussionTopicMenu {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Discussion Topic Menu");
        }
    }
}
