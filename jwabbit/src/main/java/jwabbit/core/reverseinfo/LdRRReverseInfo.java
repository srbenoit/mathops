...
/**
 * The "ld_r_r_reverse_info" opcode.
 */
public final class LdRRReverseInfo implements IRevOpcode {

    /**
     * Constructs a new {@code LdRRReverseInfo}.
     */
    public LdRRReverseInfo() {

        // No action
    }

    /**
     * Opcode ld_r_r_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "ld_r_r_reverse_info" function.
     */
    @Override
