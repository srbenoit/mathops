...
/**
 * A page with the "assignment_selection" placement.
 */
enum PageAssignmentSelection {
    ;
    ...
    static void showPage(final Cache cache, final ServletRequest req, final HttpServletResponse resp,
        ...
        if (ltiData == null) {
            ...
            LTITarget.showDefault(ltiData, payload, req, resp, "CSU LTI Tool Assignment Selection");
        }
    }
}
