...
public final class RawStmathplan extends RecBase implements Comparable<RawStmathplan> {
    ...
    /**
     * Constructs a new {@code RawStmathplan} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStmathplan parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        } else if (FLD_SESSION.equals(name)) {
            this.session = Long.valueOf(value);
        }
    }
    ...
    /**
     * Extracts an "stmathplan" record from a result set.
     *
