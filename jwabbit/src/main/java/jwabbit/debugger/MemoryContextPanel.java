...
/**
 * A panel to display details of a memory context.
 */
final class MemoryContextPanel extends LoggedPanel implements ICalcStateListener {

    /** Version number for serialization. */
    @Serial
    private static final long serialVersionUID = -6731088436137547534L;

    /** The detail panel. */
    private final MemoryContextDetailPanel memDetail;

    /**
     * Constructs a new {@code MemoryContextPanel}.
     */
    MemoryContextPanel() {
        ...
        final JLabel title = new JLabel("Memory Context Detail");
        ...
        this.memDetail = new MemoryContextDetailPanel();
        center.add(this.memDetail, BorderLayout.CENTER);
    }
    ...
    public void calcState(final Calc theCalc) {
        ...
        if (this.isShowing()) {
            this.memDetail.calcState(theCalc);
        }
    }
    ...
    public void enableControls(final boolean enable) {
        ...
        this.memDetail.enableControls(enable);
    }
}
