...
public final class RawStmpe extends RecBase implements Comparable<RawStmpe> {
    ...
    /**
     * Constructs a new {@code RawStmpe} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStmpe parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_STU_ID.equals(name)) {
            ...
            this.version = value;
        } else if (FLD_ACADEMIC_YR.equals(name)) {
            this.academicYr = value;
        } else if (FLD_EXAM_DT.equals(name)) {
            this.examDt = LocalDate.parse(value);
        } else if (FLD_START_TIME.equals(name)) {
        ...
        } else if (FLD_STS_A.equals(name)) {
            this.stsA = Integer.valueOf(value);
        } else if (FLD_STS_117.equals(name)) {
            this.sts117 = Integer.valueOf(value);
        } else if (FLD_STS_118.equals(name)) {
            this.sts118 = Integer.valueOf(value);
        } else if (FLD_STS_124.equals(name)) {
            this.sts124 = Integer.valueOf(value);
        } else if (FLD_STS_125.equals(name)) {
            this.sts125 = Integer.valueOf(value);
        } else if (FLD_STS_126.equals(name)) {
            this.sts126 = Integer.valueOf(value);
        } else if (FLD_PLACED.equals(name)) {
            this.placed = value;
        } else if (FLD_HOW_VALIDATED.equals(name)) {
            this.howValidated = value;
        }
    }
    ...
    /**
     * Extracts an "stmpe" record from a result set.
     *
