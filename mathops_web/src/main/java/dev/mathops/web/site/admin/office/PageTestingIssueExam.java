...
enum PageTestingIssueExam {
    ...
    static void doGet(final StudentData studentData, final AdminSite site, final ServletRequest req,
        ...
        if (stuId == null || stuId.isEmpty()) {
            ...
            final StudentData studentData = new StudentData(cache, cleanStu, ELiveRefreshes.NONE);
            ...
            if (stu == null) {
                ...
                final List<RawPendingExam> pend = studentData.getPendingExams();
                ...
                if (pend.isEmpty()) {
                    ...
                    if (req.getParameter("ignorehold") != null) {
                        ...
                        if ("F".equals(stu.sevAdminHold)) {
                            ...
                            if (holds.isEmpty()) {
                                ...
                                studentData.forgetStudentRecord();
                                go = true;
                            } else {
                    ...
                    if (go) {
                        ...
                        if (exam == null) {
                            ...
                            final String errmsg = verifyEligible(studentData, exam);
     ...
     * @throws SQLException if there is an error accessing the database
     */
    private static String verifyEligible(final StudentData studentData, final String examId) throws SQLException {
        ...
        if ("MT4UE".equals(examId)) {
            ...
            final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M100T, unit4
                    , true, "R");
            if (exams.isEmpty()) {
            ...
            final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M1170, unit4,
                    true, "R");
            if (exams.isEmpty()) {
            ...
            final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M1180, unit4,
                    true, "R");
            if (exams.isEmpty()) {
            ...
            final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M1240, unit4,
                    true, "R");
            if (exams.isEmpty()) {
            ...
            final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M1250, unit4,
                    true, "R");
            if (exams.isEmpty()) {
            ...
            final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M1260, unit4,
                    true, "R");
            if (exams.isEmpty()) {
            ...
            // Student MUST have a passed Unit Review exam in unit 4 of M 1260
            final List<RawStmpe> exams = studentData.getLegalPlacementAttempts();
            int numUsed = 0;
            ...
            final List<RawStchallenge> tries = studentData.getChallengeExamsByCourse(RawRecordConstants.M117);

            if (tries.isEmpty()) {
                final List<RawStcourse> regs = studentData.getNonChallengeRegistrations(active.term);
                boolean in117 = false;
                ...
                } else if (!new PrerequisiteLogic(studentData).hasSatisfiedPrereqsFor(RawRecordConstants.M117)) {
            ...
            final List<RawStchallenge> tries = studentData.getChallengeExamsByCourse(RawRecordConstants.M118);
            ...
            if (tries.isEmpty()) {
                ...
                } else if (!new PrerequisiteLogic(studentData).hasSatisfiedPrereqsFor(RawRecordConstants.M118)) {
            ...
            final List<RawStchallenge> tries = studentData.getChallengeExamsByCourse(RawRecordConstants.M124);
            ...
            if (tries.isEmpty()) {
                ...
                } else if (!new PrerequisiteLogic(studentData).hasSatisfiedPrereqsFor(RawRecordConstants.M124)) {
            ...
            final List<RawStchallenge> tries = studentData.getChallengeExamsByCourse(RawRecordConstants.M125);
            ...
            if (tries.isEmpty()) {
                ...
                } else if (!new PrerequisiteLogic(studentData).hasSatisfiedPrereqsFor(RawRecordConstants.M125)) {
            ...
            final List<RawStchallenge> tries = studentData.getChallengeExamsByCourse(RawRecordConstants.M126);
            ...
            if (tries.isEmpty()) {
                ...
                } else if (!new PrerequisiteLogic(studentData).hasSatisfiedPrereqsFor(RawRecordConstants.M126)) {
                    errmsg = "Student has not satisfied prereqs for MATH 126";
                }
            } else {
                errmsg = "Student has already challenged MATH 126";
            }
        } else if ("Y".equals(studentData.getStudentRecord().licensed)) {

            if ("171UE".equals(examId)) {
                // Student MUST have a passed Unit 1 Review exam in M 117
                final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M117,
                        unit1, true, "R");
                if (exams.isEmpty()) {
                ...
                final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M118,
                        unit1, true, "R");
                if (exams.isEmpty()) {
                ...
                final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M124,
                        unit1, true, "R");
                if (exams.isEmpty()) {
                ...
                final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M125,
                        unit1, true, "R");
                if (exams.isEmpty()) {
                ...
                // Student MUST have a passed Unit 1 Review exam in M 125
                final List<RawStexam> exams = studentData.getStudentExamsByCourseUnitType(RawRecordConstants.M126,
                        unit1, true, "R");
                if (exams.isEmpty()) {
