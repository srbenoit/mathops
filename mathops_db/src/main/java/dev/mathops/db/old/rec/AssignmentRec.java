...
public final class AssignmentRec extends RecBase implements Comparable<AssignmentRec> {
    ...
    /**
     * Constructs a new {@code AssignmentRec} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static AssignmentRec parse(final String toParse) {
    ...
    protected void setField(final String name, final String value)
        ...
        if (FLD_ASSIGNMENT_ID.equals(name)) {
            this.assignmentId = value;
        } else if (FLD_ASSIGNMENT_TYPE.equals(name)) {
            ...
            this.title = value;
        } else if (FLD_TREE_REF.equals(name)) {
            this.treeRef = value;
        } else if (FLD_WHEN_ACTIVE.equals(name)) {
            this.whenActive = LocalDateTime.parse(value);
        } else if (FLD_WHEN_PULLED.equals(name)) {
            this.whenPulled = LocalDateTime.parse(value);
        }
    }
