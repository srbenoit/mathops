...
/**
 * The "sla_ind_reverse_info" opcode.
 */
public final class SlaIndReverseInfo implements IRevIndexOpcode {

    /**
     * Constructs a new {@code SlaIndReverseInfo}.
     */
    public SlaIndReverseInfo() {

        // No action
    }

    /**
     * Opcode sla_ind_reverse_info.
     *
     * <p>
     * WABBITEMU SOURCE: core/reverse_info.c, "sla_ind_reverse_info" function.
     */
    @Override
