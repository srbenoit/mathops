...
public final class RawStlessonAssign extends RecBase implements Comparable<RawStlessonAssign> {
    ...
    /**
     * Constructs a new {@code RawStlessonAssign} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStlessonAssign parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_STU_ID.equals(name)) {
            ...
            this.lessonId = value;
        } else if (FLD_WHEN_SHOWN.equals(name)) {
            this.whenShown = LocalDateTime.parse(value);
        } else if (FLD_WHEN_OPEN.equals(name)) {
            this.whenOpen = LocalDateTime.parse(value);
        } else if (FLD_WHEN_CLOSED.equals(name)) {
            this.whenClosed = LocalDateTime.parse(value);
        } else if (FLD_WHEN_HIDDEN.equals(name)) {
            this.whenHidden = LocalDateTime.parse(value);
        ...
        } else if (FLD_SCORE_TENTHS.equals(name)) {
            this.scoreTenths = Integer.valueOf(value);
        }
    }
