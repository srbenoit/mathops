...
public final class RawStresource extends RecBase implements Comparable<RawStresource> {
    ...
    /**
     * Constructs a new {@code RawStresource} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawStresource parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_STU_ID.equals(name)) {
            this.stuId = value;
        } else if (FLD_RESOURCE_ID.equals(name)) {
            this.resourceId = value;
        } else if (FLD_LOAN_DT.equals(name)) {
            this.loanDt = LocalDate.parse(value);
        } else if (FLD_START_TIME.equals(name)) {
            this.startTime = Integer.valueOf(value);
        } else if (FLD_DUE_DT.equals(name)) {
            this.dueDt = LocalDate.parse(value);
        } else if (FLD_RETURN_DT.equals(name)) {
            this.returnDt = LocalDate.parse(value);
    ...
    /**
     * Extracts an "stresource" record from a result set.
     *
    ...
    public int hashCode() {
        ...
        return EqualityTests.objectHashCode(this.stuId)
                + EqualityTests.objectHashCode(this.resourceId)
                + EqualityTests.objectHashCode(this.loanDt)
                + EqualityTests.objectHashCode(this.startTime)
                + EqualityTests.objectHashCode(this.dueDt)
                + EqualityTests.objectHashCode(this.returnDt)
