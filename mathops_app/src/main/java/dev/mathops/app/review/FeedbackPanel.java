...
class FeedbackPanel extends InternalPanelBase implements ActionListener {
    ...
    @Serial
    private static final long serialVersionUID = 7325981620363342926L;
     ...
     * @param examVersion   the version of exam that was taken
     */
    FeedbackPanel(final String theUsername, final Map<String, Integer> subtestScores,
                  final Map<String, Object> examGrades, final String examVersion) {

        super(null, theUsername);

        setResOwner(this);

        final Properties res = AppFileLoader.loadFileAsProperties(FeedbackPanel.class,
                "FeedbackPanelSkin", new DefaultFeedbackPanelSkin(), false);
        final Runnable builder =
                new FeedbackGUIBuilder(this, res, subtestScores, examGrades, examVersion);
...
class FeedbackGUIBuilder implements Runnable {
    ...
    /** The version of exam that was taken. */
     ...
     * @param theExamVersion   the version of exam that was taken
     */
    FeedbackGUIBuilder(final FeedbackPanel theOwner, final Properties theRes,
                       final Map<String, Integer> theSubtestScores, final Map<String, Object> theExamGrades,
                       final String theExamVersion) {
    ...
    public void run() {
        ...
        final String label = this.examVersion.startsWith("30") ? "quiz" : "exam";
        final HtmlBuilder str = new HtmlBuilder(100);

        if (score != null) {
            str.add("<html>Your score on this ", label, " was &nbsp; <strong>", score, "</strong>.").br();
            ...
            str.add("<html>Your ", label, " was not graded.</html>");
        }
...
class ShowFeedback implements Runnable {
    ...
    /**
     * Constructs a new {@code ShowFeedback}.
     *
...
class CloseFeedback implements Runnable {
    ...
    /**
     * Constructs a new {@code CloseFeedback}.
     *
...
class DefaultFeedbackPanelSkin extends Properties {
    ...
    /** Version number for serialization. */
    @Serial
    private static final long serialVersionUID = -6271767299007744167L;
