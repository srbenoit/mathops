...
public final class RawNewstu extends RecBase implements Comparable<RawNewstu> {
    ...
    /**
     * Constructs a new {@code RawNewstu} by parsing the string format generated by {@code serializedString}.
     *
     * @param toParse the string to parse
     * @return the parsed object
     * @throws IllegalArgumentException if the string cannot be parsed
     */
    public static RawNewstu parse(final String toParse) {
    ...
    protected void setField(final String name, final String value) throws IllegalArgumentException {
        ...
        if (FLD_STU_ID.equals(name)) {
            this.stuId = value;
        } else if (FLD_ACAD_LEVEL.equals(name)) {
            this.acadLevel = value;
        } else if (FLD_REG_TYPE.equals(name)) {
            this.regType = value;
        } else if (FLD_TERM.equals(name)) {
            this.term = value;
        }
    }
