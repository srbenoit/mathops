...
public final class RawChallengeFee extends RecBase implements Comparable<RawChallengeFee> {
    ...
    /**
     * Extracts an "challenge_fee" record from a result set.
     *
