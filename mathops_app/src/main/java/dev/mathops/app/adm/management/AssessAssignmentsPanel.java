...
/**
 * A panel that presents all configured assignments ("homeworks") and allows the user to add, delete, and edit.
 */
final class AssessAssignmentsPanel extends AdminPanelBase implements ActionListener {
