...
/**
 * A mid-controller that handles requests to the "placement.[domain]" host whose request paths don't begin with "/www/".
 */
public final class CourseMidController implements IMidController {
    ...
    /**
     * Constructs a new {@code CourseMidController}.
     *
     ...
     */
    CourseMidController(final ServletConfig config) throws ServletException {
