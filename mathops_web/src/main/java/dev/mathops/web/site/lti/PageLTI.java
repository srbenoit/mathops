...
enum PageLTI {
    ...
    static void doGetCartridgeBasicLTILink(final ServletRequest req,
        ...
        htm.addln("<blti:title>CSU Precalculus Program</blti:title>");
        htm.addln("<blti:description>In-Canvas Delivery of Precalculus Courses.</blti:description>");
        htm.addln("<blti:icon>https://", HOST, "/images/bullet.png</blti:icon>");

        htm.addln("<blti:secure_launch_url>https://", HOST, "/lti/launch.html</blti:secure_launch_url>");

        htm.addln("<blti:extensions platform=\"canvas.instructure.com\">");
        htm.addln("  <lticm:property name=\"tool_id\">CSU_Precalculus</lticm:property>");
        ...
        htm.addln("  <lticm:property name=\"text\">Precalculus Courses.</lticm:property>");

        //

        // *** ACCOUNT NAVIGATION - menu item in the administrator account under which the tool is installed in Canvas.
        ...
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/account_navigation.html</lticm:property>");
        ...
        // *** ASSIGNMENT MENU - this appears in the context menu to configure an assignment, along with "Delete" and
        // "Duplicate".
        ...
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/assignment_menu.html</lticm:property>");
        htm.addln("  </lticm:options>");

        //

        // *** ASSIGNMENT SELECTION - When an assignment is set to "external tool" as its submission type, "Find" has
        // this link
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelectionRequest</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/assignment_selection.html</lticm:property>");
        htm.addln("  </lticm:options>");

        //

        // *** COURSE HOME SUBNAVIGATION - This appears in the right-hand stack of buttons within each course (for the
        // instructor, this appears below "Import existing content", and above "Choose Home Page", and for the student,
        // it appears at the top, above "View Course Stream")
        ...
        // *** COURSE NAVIGATION - this link appears in the left-hand course menu, along with "Assignments", "Modules",
        // "Pages", etc.

        htm.addln("  <lticm:options name=\"course_navigation\">");
        htm.addln("    <lticm:property name=\"enabled\">true</lticm:property>");
        htm.addln("    <lticm:property name=\"text\">course_navivation Text</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/math_refresher.html</lticm:property>");
        htm.addln("    <lticm:options name=\"labels\">");
        ...
        // *** COURSE SETTINGS SUBNAVIGATION - this appears in the stack of buttons on the right side within course
        // settings (available to course owner), along with "Course Statistics", "Course Calendar", etc.

        htm.addln("  <lticm:options name=\"course_settings_sub_navigation\">");
        htm.addln("    <lticm:property name=\"enabled\">true</lticm:property>");
        htm.addln("    <lticm:property name=\"text\">Math Refresher Settings</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST,
        ...
        // *** Discussion topic menu - this appears in the context menu of a discussion (available to the owner, not to
        // students), along with "Pin", or "Close for comments". It also appears in the context menu of an announcement.
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelectionRequest</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/editor_button.html</lticm:property>");
        htm.addln("  </lticm:options>");
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelection</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/file_menu.html</lticm:property>");
        htm.addln("  </lticm:options>");

        //

        // *** GLOBAL NAVIGATION - this would appear in the left-hand menu along with "Dashboard", "Courses", and
        // "Calendar" - operations not associated with any course

        htm.addln("  <lticm:options name=\"global_navigation\">");
        htm.addln("    <lticm:property name=\"enabled\">true</lticm:property>");
        htm.addln("    <lticm:property name=\"text\">global_navigation Text</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/global_navigation.html</lticm:property>");
        htm.addln("  </lticm:options>");

        //

        // *** HOMEWORK SUBMISSION - when an assignment is configured to allow file upload as a submission type, the
        // submission panel for the student will include "File Upload" and this link as options.
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelectionRequest</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/homework_submission.html</lticm:property>");
        htm.addln("  </lticm:options>");

        //

        // *** LINK SELECTION - When adding an item to a module, if "External Tool" is chosen, this appears as an
        // option.
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelectionRequest</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/link_selection.html</lticm:property>");
        htm.addln("  </lticm:options>");
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelectionRequest</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/migration_selection.html</lticm:property>");
        htm.addln("  </lticm:options>");
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelection</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/module_menu.html</lticm:property>");
        htm.addln("  </lticm:options>");
        ...
        htm.addln("    <lticm:property name=\"message_type\">ContentItemSelection</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/quiz_menu.html</lticm:property>");
        htm.addln("  </lticm:options>");
        ...
        // *** USER NAVIGATION - menu item under each user's "Account" sub-menu or under the "Settings" page for the
        // user.

        htm.addln("  <lticm:options name=\"user_navigation\">");
        htm.addln("    <lticm:property name=\"enabled\">true</lticm:property>");
        htm.addln("    <lticm:property name=\"text\">user_navigation Text</lticm:property>");
        htm.addln("    <lticm:property name=\"url\">https://", HOST, "/lti/user_navigation.html</lticm:property>");
        htm.addln("    <lticm:options name=\"labels\">");
        ...
        // *** PAGE MENU - appears in the context menu for a page, along with "Use as Front Page", and "View Page
        // History"
