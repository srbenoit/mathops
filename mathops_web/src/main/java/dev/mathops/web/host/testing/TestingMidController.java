package dev.mathops.web.host.testing;
...
import dev.mathops.web.host.testing.testing.TestingCenterSite;
import dev.mathops.web.host.testing.txn.TxnSite;
import dev.mathops.web.host.testing.webservice.WebServiceSite;
...
/**
 * A mid-controller that handles requests to the "testing.[domain]" host whose request paths don't begin with "/www/".
 */
public final class TestingMidController implements IMidController {
    ...
    /**
     * Constructs a new {@code TestingMidController}.
     *
     ...
     */
    TestingMidController(final ServletConfig config) throws ServletException {
