...
/**
 * A factory class that can generate messages to students who are "late" (urgency >= 1) and who have not yet satisfied
 * prerequisites for their first class.
 */
enum LateMessagePrereqFactory {
    ;
    ...
    private static MessageToSend generatePREQpr00(final MessagingContext context,
        ...
        body.addln("Any progress on getting the prerequisite situation resolved for ", crsName,
                "?  It looks like you still have two Math Placement Tool ",
                "attempts that could work.");
        body.addln();
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr00, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr01(final MessagingContext context,
        ...
        body.add("Just checking again to see if there's anything I can do to help you get ",
                "the prerequisites cleared for ", crsName, ".  Have you checked out ",
                "the Math Placement web site to see if that's a good option?");
        body.addln();

        MsgUtils.emitSimpleClosing(body);

        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr01, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr02(final MessagingContext context,
        ...
        body.add("Sorry for being a pest - would it make sense at this point to drop ");
        if (context.pace == 2) {
            body.addln("your second course so the deadlines for this course can spread out ",
                    "and give you more time to get things settled?");
        } else {
            body.addln("one of your later courses so the deadlines for this course can spread ",
                    "out and give you more time to get things settled?");
        }
        body.addln();
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr02, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr03(final MessagingContext context,
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr03, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr04(final MessagingContext context,
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr04, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr05(final MessagingContext context,
        ...
        body.add("Sorry for being a pest - would it make sense at this point to drop ");
        if (context.pace == 2) {
            body.add("your second course so the deadlines for this course can spread out ",
                    "and give you more time to get things settled?");
        } else {
            body.add("one of your later courses so the deadlines for this course can spread ",
                    "out and give you more time to get things settled?");
        }
        body.addln();
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr05, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr06(final MessagingContext context,
        ...
        if (status.milestones.r1.minusDays(3L).isBefore(context.today)) {
            body.add("Course due dates are moving along - I want to make sure you get things ",
                    "straightened out in time to succeed in the course.");
            body.addln();
        }
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr06, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr07(final MessagingContext context,
        ...
        body.add("Just checking again to see if there's anything I can do to help you get ",
                "the prerequisites cleared for ", crsName, ".");
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr07, "Course prerequisites", body.toString());
    }
    ...
    private static MessageToSend generatePREQpr08(final MessagingContext context,
        ...
        return new MessageToSend(context, status, Integer.valueOf(0), EMilestone.PREREQ,
                EMsg.PREQpr08, "Course prerequisites", body.toString());
    }
